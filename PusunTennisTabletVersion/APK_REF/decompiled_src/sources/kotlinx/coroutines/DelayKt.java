...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1985scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1922delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1923toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1923toDelayMillisLRDsOJo(long j) {
        if (Duration.m1758compareToLRDsOJo(j, Duration.INSTANCE.m1861getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1777getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
