...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1973boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m1974constructorimpl(Object obj) {
        return obj;
    }
    ...
    public boolean equals(Object obj) {
        return m1976equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1979hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1981toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1975constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1974constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m1980plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m1974constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m1974constructorimpl(arrayList);
    }

    /* renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1978forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
