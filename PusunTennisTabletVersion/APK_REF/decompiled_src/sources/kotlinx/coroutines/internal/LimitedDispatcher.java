...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1985scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1985scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo1984dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo1984dispatch(this, this);
    }
