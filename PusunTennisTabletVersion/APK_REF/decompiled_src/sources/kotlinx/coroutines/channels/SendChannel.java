...
public interface SendChannel<E> {
    ...
    Object mo1938trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1938trySendJP2dKIU = sendChannel.mo1938trySendJP2dKIU(e);
            if (ChannelResult.m1953isSuccessimpl(mo1938trySendJP2dKIU)) {
                return true;
            }
            Throwable m1947exceptionOrNullimpl = ChannelResult.m1947exceptionOrNullimpl(mo1938trySendJP2dKIU);
