...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m383constructorimpl = Result.m383constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m383constructorimpl = Result.m383constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m389isFailureimpl(m383constructorimpl) ? null : m383constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1961installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1961installSignalHandler$lambda1(Signal signal) {
