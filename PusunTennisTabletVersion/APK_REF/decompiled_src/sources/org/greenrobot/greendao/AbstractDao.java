    ...
    */
    protected java.util.List<T> loadAllFromCursor(android.database.Cursor r7) {
        ...
        L5e:
            if (r4 != 0) goto L6a
            if (r2 == 0) goto L6a
            org.greenrobot.greendao.identityscope.IdentityScope<K, T> r0 = r6.identityScope     // Catch: java.lang.Throwable -> L7f
            if (r0 == 0) goto L6a
            r6.loadAllUnlockOnWindowBounds(r7, r2, r1)     // Catch: java.lang.Throwable -> L7f
            goto L77
        L6a:
            java.lang.Object r0 = r6.loadCurrent(r7, r3, r3)     // Catch: java.lang.Throwable -> L7f
