...
public final class HttpUrl {
    ...
    public String encodedQuery() {
        ...
        int i = indexOf + 1;
        String str = this.url;
        return this.url.substring(i, Util.delimiterOffset(str, indexOf + 2, str.length(), '#'));
    }
    ...
    public static final class Builder {
        ...
        private void push(String str, int i, int i2, boolean z, boolean z2) {
            ...
            if (this.encodedPathSegments.get(r10.size() - 1).isEmpty()) {
                this.encodedPathSegments.set(r10.size() - 1, canonicalize);
            } else {
        ...
        */
        private static java.net.InetAddress decodeIpv6(java.lang.String r12, int r13, int r14) {
            ...
            L4d:
                ...
                int r10 = okhttp3.HttpUrl.decodeHexDigit(r10)
                if (r10 != r3) goto L5a
                goto L60
            L5a:
                int r8 = r8 << 4
        ...
        private static int parsePort(String str, int i, int i2) {
            int parseInt;
            try {
                parseInt = Integer.parseInt(HttpUrl.canonicalize(str, i, i2, "", false, false, false, true));
