...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: cn.qqtheme.framework.popup.ConfirmPopup.1
        ...
        button2.setOnClickListener(new View.OnClickListener() { // from class: cn.qqtheme.framework.popup.ConfirmPopup.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ConfirmPopup.this.dismiss();
