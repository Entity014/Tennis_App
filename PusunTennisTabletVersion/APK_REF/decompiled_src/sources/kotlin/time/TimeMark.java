...
public interface TimeMark {
    ...
    TimeMark mo1749minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1751plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1896plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1895minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1751plusLRDsOJo(Duration.m1811unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1792isNegativeimpl(timeMark.mo1748elapsedNowUwyO8pc());
        }
