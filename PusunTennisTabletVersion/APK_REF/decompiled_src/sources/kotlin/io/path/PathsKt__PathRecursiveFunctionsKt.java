        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1619m(obj2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1619m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1619m((Object) path2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1619m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1619m((Object) path3), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1619m((Object) path4));
                }
    ...
    */
    public static final java.nio.file.Path copyToRecursively(final java.nio.file.Path r7, final java.nio.file.Path r8, final kotlin.jvm.functions.Function3<? super java.nio.file.Path, ? super java.nio.file.Path, ? super java.lang.Exception, ? extends kotlin.io.path.OnErrorResult> r9, boolean r10, final kotlin.jvm.functions.Function3<? super kotlin.io.path.CopyActionContext, ? super java.nio.file.Path, ? super java.nio.file.Path, ? extends kotlin.io.path.CopyActionResult> r11) {
        /*
            ...
            if (r1 == 0) goto Lc3
            if (r10 != 0) goto L45
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1642m$1(r7)
            if (r1 != 0) goto Lc3
        L45:
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.lang.Object[] r1 = java.util.Arrays.copyOf(r1, r0)
            ...
            r2 = 1
            if (r1 == 0) goto L5c
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1642m$1(r8)
            if (r1 != 0) goto L5c
            r1 = 1
            goto L5d
        L5c:
        ...
        L5d:
            if (r1 == 0) goto L65
            boolean r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1635m(r7, r8)
            if (r3 != 0) goto Lc3
        L65:
            java.nio.file.FileSystem r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1610m(r7)
            java.nio.file.FileSystem r4 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1610m(r8)
        ...
        L74:
            if (r1 == 0) goto L87
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r8, r1)
            java.nio.file.LinkOption[] r0 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r7, r0)
            boolean r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1643m$1(r1, r0)
            goto Lae
        L87:
            ...
            boolean r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(r1, r3)
            if (r3 == 0) goto Lae
            java.nio.file.LinkOption[] r3 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r1, r3)
            java.nio.file.LinkOption[] r3 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r7, r3)
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1643m$1(r1, r3)
            if (r1 == 0) goto Lae
            r0 = 1
        Lae:
            if (r0 != 0) goto Lb1
            goto Lc3
        Lb1:
            kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1631m()
            java.lang.String r7 = r7.toString()
            java.lang.String r8 = r8.toString()
            java.lang.String r9 = "Recursively copying a directory into its subdirectory is prohibited."
            java.nio.file.FileSystemException r7 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r7, r8, r9)
            throw r7
        Lc3:
            ...
            return r8
        Ld4:
            kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1644m$2()
            java.lang.String r7 = r7.toString()
            java.lang.String r8 = r8.toString()
            java.lang.String r9 = "The source file doesn't exist."
            java.nio.file.NoSuchFileException r7 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1618m(r7, r8, r9)
            throw r7
        */
        ...
        if (parent != null) {
            ...
            if (directoryStream != null) {
                ...
                try {
                    ...
                    if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1633m((Object) m)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream m1622m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1622m((Object) m);
                        fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "this.fileName");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(m1622m, fileName, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            SecureDirectoryStream m1622m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1622m((Object) secureDirectoryStream3);
            it = m1622m.iterator();
            while (it.hasNext()) {
                fileName = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1619m(it.next()).getFileName();
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        ...
        try {
            ...
            readAttributes = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1625m((Object) fileAttributeView).readAttributes();
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            while (it.hasNext()) {
                Path entry = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1619m(it.next());
