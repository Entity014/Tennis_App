...
public class CircleBubbleView extends View {
    ...
    CircleBubbleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    CircleBubbleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(String maxLengthText) {
        ...
        this.mPaint.getTextBounds(maxLengthText, 0, maxLengthText.length(), new Rect());
