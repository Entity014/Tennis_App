...
class LZWEncoder {
    ...
    int cur_accum = 0;
    int cur_bits = 0;
    int[] masks = {0, 1, 3, 7, 15, 31, 63, WorkQueueKt.MASK, 255, FrameMetricsAggregator.EVERY_DURATION, AnalyticsListener.EVENT_DRM_KEYS_LOADED, 2047, 4095, 8191, 16383, 32767, 65535};
