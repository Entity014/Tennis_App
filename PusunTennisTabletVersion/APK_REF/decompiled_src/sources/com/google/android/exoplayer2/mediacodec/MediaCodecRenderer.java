...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    */
    protected void onStreamChanged(com.google.android.exoplayer2.Format[] r16, long r17, long r19) throws com.google.android.exoplayer2.ExoPlaybackException {
        /*
            r15 = this;
            r0 = r15
    ...
    */
    ...
    private void initCodec(MediaCodecInfo mediaCodecInfo, MediaCrypto mediaCrypto) throws Exception {
        ...
        float codecOperatingRateV23 = i < 23 ? CODEC_OPERATING_RATE_UNSET : getCodecOperatingRateV23(this.targetPlaybackSpeed, this.inputFormat, getStreamFormats());
    ...
    */
    ...
    private void bypassRead() throws ExoPlaybackException {
        ...
        do {
            ...
            if (format2 != null && format2.sampleMimeType != null && this.inputFormat.sampleMimeType.equals(MimeTypes.AUDIO_OPUS)) {
