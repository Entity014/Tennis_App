...
public final class OutputConsumerAdapterV30 implements MediaParser$OutputConsumer {
    ...
    private static final class SeekMapAdapter implements SeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j) {
            ...
            if (seekPoints.first == seekPoints.second) {
                return new SeekMap.SeekPoints(asExoPlayerSeekPoint(Chip$$ExternalSyntheticApiModelOutline0.m347m(seekPoints.first)));
            }
            return new SeekMap.SeekPoints(asExoPlayerSeekPoint(Chip$$ExternalSyntheticApiModelOutline0.m347m(seekPoints.first)), asExoPlayerSeekPoint(Chip$$ExternalSyntheticApiModelOutline0.m347m(seekPoints.second)));
        }
    ...
    private static final class DataReaderAdapter implements DataReader {
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            int read;
            read = Chip$$ExternalSyntheticApiModelOutline0.m346m(Util.castNonNull(this.input)).read(bArr, i, i2);
            return read;
        }
    }
}
