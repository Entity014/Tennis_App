...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMultivariantPlaylist hlsMultivariantPlaylist, HlsMediaPlaylist hlsMediaPlaylist, LineIterator lineIterator, String str) throws IOException {
                                            ...
                                            if (next.startsWith(TAG_PRELOAD_HINT)) {
                                                if (part2 == null && TYPE_PART.equals(parseStringAttr(next, REGEX_PRELOAD_HINT_TYPE, hashMap))) {
                                                    ...
                                                    if (parseOptionalLongAttr == -1 || parseOptionalLongAttr2 != -1) {
                                                        part2 = new HlsMediaPlaylist.Part(parseStringAttr4, segment2, 0L, i6, j12, obj2, str5, segmentEncryptionIV, parseOptionalLongAttr != -1 ? parseOptionalLongAttr : 0L, parseOptionalLongAttr2, false, false, true);
                                                    }
                                                    hlsMultivariantPlaylist2 = hlsMultivariantPlaylist;
                                                    hlsMediaPlaylist2 = hlsMediaPlaylist;
                                                    j15 = j19;
                                                ...
                                                if (next.startsWith(TAG_PART)) {
                                                    ...
                                                    arrayList = arrayList10;
                                                    arrayList.add(new HlsMediaPlaylist.Part(parseStringAttr5, segment2, parseDoubleAttr, i6, j12, obj2, str5, segmentEncryptionIV2, j17, j5, parseOptionalBooleanAttribute2, parseOptionalBooleanAttribute, false));
                                                    j12 += parseDoubleAttr;
                                                    if (j5 != j4) {
                                                        j17 += j5;
                                                    }
                                                    ...
                                                    if (!next.startsWith("#")) {
                                                        ...
                                                        arrayList3.add(new HlsMediaPlaylist.Segment(replaceVariableReferences, segment2 != null ? segment2 : segment5, str4, j16, i6, j14, obj, str5, segmentEncryptionIV3, j2, j13, z7, arrayList));
                                                        j12 = j14 + j16;
        ...
        for (int i11 = 0; i11 < arrayList5.size(); i11++) {
            ...
            if (i12 == -1 && j10 != C.TIME_UNSET) {
                i12 = (arrayList11.isEmpty() ? ((HlsMediaPlaylist.Segment) Iterables.getLast(arrayList3)).parts : arrayList11).size() - 1;
            }
            hashMap3.put(renditionReport.playlistUri, new HlsMediaPlaylist.RenditionReport(renditionReport.playlistUri, j21, i12));
        }
        if (part3 != null) {
            arrayList11.add(part3);
        }
        return new HlsMediaPlaylist(i10, str, arrayList12, j6, z4, j7, z5, i4, j8, i5, j9, j10, z3, z6, j7 != 0, drmInitData, arrayList3, arrayList11, serverControl2, hashMap3);
    }
