...
import com.google.android.exoplayer2.AudioFocusManager$$ExternalSyntheticApiModelOutline3;
...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public static MediaMetricsListener create(Context context) {
        ...
        MediaMetricsManager m179m = AudioFocusManager$$ExternalSyntheticApiModelOutline3.m179m(context.getSystemService("media_metrics"));
        if (m179m == null) {
            return null;
        }
        createPlaybackSession = m179m.createPlaybackSession();
    ...
    public void onSessionActive(AnalyticsListener.EventTime eventTime, String str) {
        ...
        if (eventTime.mediaPeriodId == null || !eventTime.mediaPeriodId.isAd()) {
            ...
            playerName = AudioFocusManager$$ExternalSyntheticApiModelOutline3.m182m().setPlayerName(ExoPlayerLibraryInfo.TAG);
    ...
    private void maybeUpdateMetricsBuilderValues(Player player, AnalyticsListener.Events events) {
        ...
        if (events.contains(2) && this.metricsBuilder != null && (drmInitData = getDrmInitData(player.getCurrentTracks().getGroups())) != null) {
            AudioFocusManager$$ExternalSyntheticApiModelOutline3.m183m(Util.castNonNull(this.metricsBuilder)).setDrmType(getDrmType(drmInitData));
        }
    ...
    private void maybeReportPlaybackError(long j) {
        ...
        timeSinceCreatedMillis = AudioFocusManager$$ExternalSyntheticApiModelOutline3.m181m().setTimeSinceCreatedMillis(j - this.startTimeMs);
    ...
    private void maybeReportNetworkChange(long j) {
        ...
        if (networkType2 != this.currentNetworkType) {
            ...
            PlaybackSession playbackSession = this.playbackSession;
            networkType = AudioFocusManager$$ExternalSyntheticApiModelOutline3.m180m().setNetworkType(networkType2);
    ...
    private void maybeReportPlaybackStateChange(Player player, AnalyticsListener.Events events, long j) {
        ...
        if (this.currentPlaybackState != resolveNewPlaybackState) {
            ...
            this.reportedEventsForCurrentSession = true;
            PlaybackSession playbackSession = this.playbackSession;
            state = AudioFocusManager$$ExternalSyntheticApiModelOutline3.m184m().setState(this.currentPlaybackState);
    ...
    private void reportTrackChangeEvent(int i, long j, Format format, int i2) {
        ...
        timeSinceCreatedMillis = AudioFocusManager$$ExternalSyntheticApiModelOutline3.m185m(i).setTimeSinceCreatedMillis(j - this.startTimeMs);
        if (format != null) {
    ...
    private static ErrorInfo getErrorInfo(PlaybackException playbackException, Context context, boolean z) {
        ...
        if (th instanceof DrmSession.DrmSessionException) {
            ...
            if (Util.SDK_INT >= 23 && AudioFocusManager$$ExternalSyntheticApiModelOutline3.m191m((Object) th2)) {
