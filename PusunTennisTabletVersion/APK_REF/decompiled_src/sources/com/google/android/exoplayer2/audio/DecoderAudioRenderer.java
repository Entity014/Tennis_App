...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleDecoderOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.decoder != null) {
            try {
                ...
                throw createRendererException(e6, this.inputFormat, PlaybackException.ERROR_CODE_DECODING_FAILED);
            }
        }
    }
    ...
    private static final class Api23 {
        ...
        public static void setAudioSinkPreferredDevice(AudioSink audioSink, Object obj) {
            audioSink.setPreferredDevice(AudioFocusManager$$ExternalSyntheticApiModelOutline3.m(obj));
        }
    }
}
