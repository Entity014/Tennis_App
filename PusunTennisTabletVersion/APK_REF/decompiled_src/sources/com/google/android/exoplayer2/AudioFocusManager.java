...
final class AudioFocusManager {
    ...
    private int requestAudioFocusV26() {
        ...
        if (audioFocusRequest == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest == null) {
                AudioFocusManager$$ExternalSyntheticApiModelOutline3.m186m();
                m = AudioFocusManager$$ExternalSyntheticApiModelOutline3.m(this.focusGainToRequest);
            } else {
                AudioFocusManager$$ExternalSyntheticApiModelOutline3.m186m();
                m = AudioFocusManager$$ExternalSyntheticApiModelOutline3.m(this.audioFocusRequest);
            }
    ...
    class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        /* synthetic */ void m193xa83e850b(int i) {
        ...
        public void onAudioFocusChange(final int i) {
            this.eventHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.AudioFocusManager$AudioFocusListener$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AudioFocusManager.AudioFocusListener.this.m193xa83e850b(i);
                }
            });
        }
    }
