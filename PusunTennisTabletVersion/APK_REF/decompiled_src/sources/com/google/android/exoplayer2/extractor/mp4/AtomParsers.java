...
final class AtomParsers {
    ...
    */
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, int i5, DrmInitData drmInitData, StsdData stsdData, int i6) throws ParserException {
        ...
        String str5 = MimeTypes.VIDEO_H263;
        if (i16 != 1831958048) {
            str = i16 == 1211250227 ? MimeTypes.VIDEO_H263 : null;
        } else {
            ...
            if (readInt2 == 1635148611) {
                ...
                if (readInt2 == 1685480259 || readInt2 == 1685485123) {
                    ...
                    if (readInt2 == 1987076931) {
                        ExtractorUtil.checkContainerInput(str == null, null);
                        str3 = i16 == 1987063864 ? MimeTypes.VIDEO_VP8 : MimeTypes.VIDEO_VP9;
                        ...
                        byteBuffer3.putShort((short) (readUnsignedInt / OkHttpUtils.DEFAULT_MILLISECONDS));
                        byteBuffer3.putShort((short) (readUnsignedInt2 / OkHttpUtils.DEFAULT_MILLISECONDS));
        ...
        Format.Builder drmInitData5 = new Format.Builder().setId(i4).setSampleMimeType(str).setCodecs(str6).setWidth(readUnsignedShort).setHeight(i21).setPixelWidthHeightRatio(f4).setRotationDegrees(i5).setProjectionData(bArr).setStereoMode(i17).setInitializationData(list4).setDrmInitData(drmInitData4);
        int i24 = i19;
