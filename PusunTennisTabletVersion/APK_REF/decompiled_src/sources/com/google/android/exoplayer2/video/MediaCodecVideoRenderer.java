...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    */
        ...
        if (z4 && j != this.initialPositionUs) {
            ...
            if (Util.SDK_INT >= 21) {
                ...
                if (calculateEarlyTimeUs > 11000) {
                    try {
                        Thread.sleep((calculateEarlyTimeUs - OkHttpUtils.DEFAULT_MILLISECONDS) / 1000);
    ...
    public boolean shouldForceRender(long j, long j2) {
        ...
        if (this.joiningDeadlineMs == C.TIME_UNSET && j >= getOutputStreamOffsetUs()) {
            if (z2) {
                return true;
            }
    ...
    private static final class VideoFrameProcessorManager {
        ...
        public boolean maybeEnable(final Format format, long j) throws ExoPlaybackException {
            ...
            try {
                ...
                VideoFrameProcessor create = frameProcessorFactory.create(context, list, debugViewProvider, colorInfo, colorInfo2, false, new DefaultAudioSink$StreamEventCallbackV29$$ExternalSyntheticLambda2(handler), new VideoFrameProcessor.Listener() { // from class: com.google.android.exoplayer2.video.MediaCodecVideoRenderer.VideoFrameProcessorManager.1
