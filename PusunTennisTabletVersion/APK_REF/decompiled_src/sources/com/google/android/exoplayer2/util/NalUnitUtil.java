...
public final class NalUnitUtil {
    ...
    public static SpsData parseSpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (readBits == 100 || readBits == 110 || readBits == 122 || readBits == 244 || readBits == 44 || readBits == 83 || readBits == 86 || readBits == 118 || readBits == 128 || readBits == 138) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                int i10 = readUnsignedExpGolombCodedInt != 3 ? 8 : 12;
                int i11 = 0;
                while (i11 < i10) {
                    if (parsableNalUnitBitArray.readBit()) {
        ...
        if (readUnsignedExpGolombCodedInt4 == 0) {
            ...
            if (readUnsignedExpGolombCodedInt4 == 1) {
                ...
                i3 = readUnsignedExpGolombCodedInt;
                for (int i12 = 0; i12 < readUnsignedExpGolombCodedInt5; i12++) {
                    parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
                }
                z2 = readBit2;
            } else {
        ...
        int i13 = (2 - (readBit3 ? 1 : 0)) * readUnsignedExpGolombCodedInt8;
        if (!readBit3) {
            parsableNalUnitBitArray.skipBit();
        }
        parsableNalUnitBitArray.skipBit();
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            if (i3 == 0) {
                ...
                int i16 = i3;
                i8 = i16 == 3 ? 1 : 2;
                i9 = (i16 == 1 ? 2 : 1) * (2 - (readBit3 ? 1 : 0));
            }
            i14 -= (readUnsignedExpGolombCodedInt9 + readUnsignedExpGolombCodedInt10) * i8;
            i15 -= (readUnsignedExpGolombCodedInt11 + readUnsignedExpGolombCodedInt12) * i9;
        }
        int i17 = i14;
        float f = 1.0f;
        if (parsableNalUnitBitArray.readBit()) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (parsableNalUnitBitArray.readBit()) {
                    ...
                    i5 = ColorInfo.isoColorPrimariesToColorSpace(readBits7);
                    i7 = ColorInfo.isoTransferCharacteristicsToColorTransfer(readBits8);
                    i6 = i18;
                    return new SpsData(readBits, readBits2, readBits3, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt6, i17, i15, f, z, readBit3, readUnsignedExpGolombCodedInt3, readUnsignedExpGolombCodedInt4, i4, z2, i5, i6, i7);
                }
                i6 = i18;
                i5 = -1;
                i7 = -1;
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            int readUnsignedExpGolombCodedInt12 = parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            for (int i17 = 0; i17 < readUnsignedExpGolombCodedInt12; i17++) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                parsableNalUnitBitArray.skipBits(3);
                i5 = parsableNalUnitBitArray.readBit() ? 1 : 2;
                if (parsableNalUnitBitArray.readBit()) {
                    int readBits8 = parsableNalUnitBitArray.readBits(8);
                    int readBits9 = parsableNalUnitBitArray.readBits(8);
                    parsableNalUnitBitArray.skipBits(8);
                    i18 = ColorInfo.isoColorPrimariesToColorSpace(readBits8);
        ...
        return new H265SpsData(readBits2, readBit, readBits3, i8, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt9, readUnsignedExpGolombCodedInt10, iArr, readBits4, readUnsignedExpGolombCodedInt, i14, i3, f, i4, i5, i6);
    }
