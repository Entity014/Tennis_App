...
class AsynchronousMediaCodecBufferEnqueuer {
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        if (Util.SDK_INT >= 24) {
            Chip$$ExternalSyntheticApiModelOutline0.m352m();
            cryptoInfo2.setPattern(Chip$$ExternalSyntheticApiModelOutline0.m(cryptoInfo.encryptedBlocks, cryptoInfo.clearBlocks));
        }
    }
