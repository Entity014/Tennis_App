...
import com.pusun.pusuntennis.adapter.VariSpinPPSmartProRvAdapter;
...
public class VaryDrillActivityPPSP extends AppCompatActivity implements View.OnClickListener {
    ...
    private VariSpinPPSmartProRvAdapter variSpinRvAdapter;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        for (int i = 0; i < BasicData39.b3.length; i++) {
            BasicData39.b3[i][3] = 40;
        }
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.root_layout), new OnApplyWindowInsetsListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP$$ExternalSyntheticLambda0
            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return VaryDrillActivityPPSP.lambda$onCreate$0(view, windowInsetsCompat);
            }
        });
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                VaryDrillActivityPPSP.this.finish();
            }
        });
        ...
        if (intExtra == 10) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.2
                @Override // java.lang.Runnable
                public synchronized void run() {
                    VaryDrillActivityPPSP.this.showPoints();
                }
            }, 600L);
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.3
                @Override // java.lang.Runnable
                public synchronized void run() {
        ...
        if (intExtra == 6) {
            ...
            for (int i2 = 0; i2 < this.ballnum; i2++) {
                ...
                if (i2 == 0) {
                    if (this.lr == 0) {
                        ...
                        if (this.lh == 0) {
                            short[] sArr = BasicData39.b3[this.numleft[nextInt] - 1];
                            c4 = 3;
                        ...
                        if (this.lh == 2) {
                            short[] sArr2 = BasicData39.b3[this.numleft[nextInt] - 1];
                        ...
                        if (this.lh == 0) {
                            short[] sArr3 = BasicData39.b3[this.numright[nextInt2] - 1];
                            c3 = 3;
                        ...
                        if (this.lh == 2) {
                            short[] sArr4 = BasicData39.b3[this.numright[nextInt2] - 1];
                    ...
                    if (i2 == this.ballnum - 1 && i2 != 0) {
                        ...
                        if (this.lh == 0) {
                            short[] sArr5 = BasicData39.b3[this.nums1[nextInt3] - 1];
                            c2 = 3;
                        ...
                        if (this.lh == 2) {
                            short[] sArr6 = BasicData39.b3[this.nums1[nextInt3] - 1];
                        ...
                        if (this.lh == 0) {
                            short[] sArr7 = BasicData39.b3[this.nums1[nextInt4] - 1];
                            c = 3;
                        ...
                        if (this.lh == 2) {
                            short[] sArr8 = BasicData39.b3[this.nums1[nextInt4] - 1];
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.4
                @Override // java.lang.Runnable
                public synchronized void run() {
                    VaryDrillActivityPPSP.this.showPoints();
                }
            }, 600L);
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.5
                @Override // java.lang.Runnable
                public synchronized void run() {
                    ShowHelper.dismissProgressDialog();
                }
        ...
        this.lastpoints2.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                new ArrayList();
                List loadAll = VaryDrillActivityPPSP.this.daoSession.loadAll(WholeVary.class);
                if (loadAll != null && loadAll.size() != 0) {
                    String[] strArr = new String[loadAll.size()];
                    for (int size = loadAll.size() - 1; size >= 0; size--) {
                        strArr[(loadAll.size() - 1) - size] = ((WholeVary) loadAll.get(size)).getDaoName();
                    }
                    OptionPicker optionPicker = new OptionPicker(VaryDrillActivityPPSP.this, strArr);
                    optionPicker.setOffset(2);
                    optionPicker.setSelectedIndex(0);
                    optionPicker.setTextSize(18);
                    optionPicker.setTitleText(VaryDrillActivityPPSP.this.getResources().getString(R.string.select_route_name));
                    optionPicker.setCancelText(VaryDrillActivityPPSP.this.getResources().getString(R.string.cancel));
                    optionPicker.setSubmitText(VaryDrillActivityPPSP.this.getResources().getString(R.string.submit));
                    optionPicker.setOnOptionPickListener(new OptionPicker.OnOptionPickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.6.1
                        @Override // cn.qqtheme.framework.picker.OptionPicker.OnOptionPickListener
                        public void onOptionPicked(String str2) {
                            new ArrayList();
                            List loadAll2 = VaryDrillActivityPPSP.this.daoSession.loadAll(WholeVary.class);
                            for (int i3 = 0; i3 < loadAll2.size(); i3++) {
                                if (((WholeVary) loadAll2.get(i3)).getDaoName().equals(str2)) {
                                    VaryDrillActivityPPSP.this.select_dianwei.setText(((WholeVary) loadAll2.get(i3)).getSeles());
                                    String[] split = ((WholeVary) loadAll2.get(i3)).getSeles().split(",");
                                    VaryDrillActivityPPSP.this.selectPoints.clear();
                                    for (String str3 : split) {
                                        VaryDrillActivityPPSP.this.selectPoints.add(Integer.valueOf(Integer.parseInt(str3)));
                                    }
                                    VaryDrillActivityPPSP.this.pa = ((WholeVary) loadAll2.get(i3)).getItem3();
                                    ...
                                    for (int i4 = 0; i4 < arrayList.size(); i4++) {
                                        if (arrayList.get(i4) != null && !"".equals(arrayList.get(i4))) {
                                            VaryDrillActivityPPSP.this.setPara(((String) arrayList.get(i4)).split(","));
                                        }
                                    }
                                    VaryDrillActivityPPSP.this.showPoints();
                                    return;
                ...
                VaryDrillActivityPPSP varyDrillActivityPPSP = VaryDrillActivityPPSP.this;
                ShowHelper.toastShort(varyDrillActivityPPSP, varyDrillActivityPPSP.getResources().getString(R.string.no_route_name));
            }
        });
        this.savepoints2.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (VaryDrillActivityPPSP.this.select_dianwei.getText() != null && !VaryDrillActivityPPSP.this.select_dianwei.getText().toString().trim().isEmpty()) {
                    VaryDrillActivityPPSP.this.alert_dialog_input2();
                } else {
                    VaryDrillActivityPPSP varyDrillActivityPPSP = VaryDrillActivityPPSP.this;
                    ShowHelper.toastShort(varyDrillActivityPPSP, varyDrillActivityPPSP.getResources().getString(R.string.no_point_select));
                }
            }
        });
        this.delepoints2.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                new ArrayList();
                List loadAll = VaryDrillActivityPPSP.this.daoSession.loadAll(WholeVary.class);
                if (loadAll != null && loadAll.size() != 0) {
                    ...
                    optionPicker.setCancelText(VaryDrillActivityPPSP.this.getResources().getString(R.string.cancel));
                    optionPicker.setSubmitText(VaryDrillActivityPPSP.this.getResources().getString(R.string.submit));
                    optionPicker.setOnOptionPickListener(new OptionPicker.OnOptionPickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.8.1
                        @Override // cn.qqtheme.framework.picker.OptionPicker.OnOptionPickListener
                        public void onOptionPicked(String str2) {
                            new ArrayList();
                            List loadAll2 = VaryDrillActivityPPSP.this.daoSession.loadAll(WholeVary.class);
                            for (int i3 = 0; i3 < loadAll2.size(); i3++) {
                                if (((WholeVary) loadAll2.get(i3)).getDaoName().equals(str2)) {
                                    VaryDrillActivityPPSP.this.daoSession.delete((WholeVary) loadAll2.get(i3));
                                    ShowHelper.toastShort(VaryDrillActivityPPSP.this, VaryDrillActivityPPSP.this.getResources().getString(R.string.already_dele));
                                    return;
                                }
                            }
                        }
    ...
    public void setPara(String[] strArr) {
        BasicData39.b3[Integer.parseInt(strArr[5]) - 1][0] = Short.parseShort(strArr[0]);
        BasicData39.b3[Integer.parseInt(strArr[5]) - 1][1] = Short.parseShort(strArr[1]);
        BasicData39.b3[Integer.parseInt(strArr[5]) - 1][2] = Short.parseShort(strArr[2]);
        BasicData39.b3[Integer.parseInt(strArr[5]) - 1][3] = Short.parseShort(strArr[3]);
        BasicData39.b3[Integer.parseInt(strArr[5]) - 1][4] = Short.parseShort(strArr[4]);
    }
    ...
    public void alert_dialog_input2() {
        ...
        ((Button) inflate.findViewById(R.id.negative)).setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                create.dismiss();
            }
        });
        ((Button) inflate.findViewById(R.id.positive)).setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityPPSP.10
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (editText.getText().toString() != null && !editText.getText().toString().trim().equals("")) {
                    int size = VaryDrillActivityPPSP.this.selectPoints.size();
                    new ArrayList();
                    VaryDrillActivityPPSP.this.daoSession.loadAll(WholeVary.class);
                    WholeVary wholeVary = new WholeVary();
                    wholeVary.setDaoName("" + editText.getText().toString().trim());
                    wholeVary.setSeles(VaryDrillActivityPPSP.this.select_dianwei.getText().toString().trim());
                    wholeVary.setItem3(VaryDrillActivityPPSP.this.pa);
                    if (size >= 1) {
                        wholeVary.setPara1(VaryDrillActivityPPSP.this.setString(0));
                    }
                    if (size >= 2) {
                        wholeVary.setPara2(VaryDrillActivityPPSP.this.setString(1));
                    }
                    if (size >= 3) {
                        wholeVary.setPara3(VaryDrillActivityPPSP.this.setString(2));
                    }
                    if (size >= 4) {
                        wholeVary.setPara4(VaryDrillActivityPPSP.this.setString(3));
                    }
                    if (size >= 5) {
                        wholeVary.setPara5(VaryDrillActivityPPSP.this.setString(4));
                    }
                    if (size >= 6) {
                        wholeVary.setPara6(VaryDrillActivityPPSP.this.setString(5));
                    }
                    if (size >= 7) {
                        wholeVary.setPara7(VaryDrillActivityPPSP.this.setString(6));
                    }
                    if (size >= 8) {
                        wholeVary.setPara8(VaryDrillActivityPPSP.this.setString(7));
                    }
                    if (size >= 9) {
                        wholeVary.setPara9(VaryDrillActivityPPSP.this.setString(8));
                    }
                    if (size >= 10) {
                        wholeVary.setPara10(VaryDrillActivityPPSP.this.setString(9));
                    }
                    if (size >= 11) {
                        wholeVary.setPara11(VaryDrillActivityPPSP.this.setString(10));
                    }
                    if (size >= 12) {
                        wholeVary.setPara12(VaryDrillActivityPPSP.this.setString(11));
                    }
                    if (size >= 13) {
                        wholeVary.setPara13(VaryDrillActivityPPSP.this.setString(12));
                    }
                    if (size >= 14) {
                        wholeVary.setPara14(VaryDrillActivityPPSP.this.setString(13));
                    }
                    if (size >= 15) {
                        wholeVary.setPara15(VaryDrillActivityPPSP.this.setString(14));
                    }
                    VaryDrillActivityPPSP.this.daoSession.insertOrReplace(wholeVary);
                    create.dismiss();
                    return;
                }
                VaryDrillActivityPPSP varyDrillActivityPPSP = VaryDrillActivityPPSP.this;
                ShowHelper.toastShort(varyDrillActivityPPSP, varyDrillActivityPPSP.getResources().getString(R.string.input_route_name));
            }
        });
        create.show();
    }
    ...
    public String setString(int i) {
        return ((int) BasicData39.b3[this.selectPoints.get(i).intValue() - 1][0]) + "," + ((int) BasicData39.b3[this.selectPoints.get(i).intValue() - 1][1]) + "," + ((int) BasicData39.b3[this.selectPoints.get(i).intValue() - 1][2]) + "," + ((int) BasicData39.b3[this.selectPoints.get(i).intValue() - 1][3]) + "," + ((int) BasicData39.b3[this.selectPoints.get(i).intValue() - 1][4]) + "," + ((int) BasicData39.b3[this.selectPoints.get(i).intValue() - 1][5]);
    }
    ...
    public void showPoints() {
        if (this.selectPoints.size() != 0) {
            ...
            this.variSpinRvAdapter = new VariSpinPPSmartProRvAdapter(this.selectPoints, this);
