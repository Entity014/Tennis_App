    ...
    */
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && ComponentDialog$$ExternalSyntheticApiModelOutline0.m14m((Object) spinnerAdapter)) {
                    android.widget.ThemedSpinnerAdapter m7m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m7m((Object) spinnerAdapter);
                    dropDownViewTheme = m7m.getDropDownViewTheme();
                    if (dropDownViewTheme != theme) {
                        m7m.setDropDownViewTheme(theme);
                        return;
                    }
                    return;
                }
