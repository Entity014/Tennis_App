...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m27m(it2.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline0.m36m().getName())) {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && NotificationCompat$$ExternalSyntheticApiModelOutline0.m49m((Object) parcelable)) {
                return IconCompat.createFromIcon(NotificationCompat$$ExternalSyntheticApiModelOutline0.m32m((Object) parcelable));
            }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (Build.VERSION.SDK_INT >= 28) {
                    NotificationCompat$$ExternalSyntheticApiModelOutline0.m51m$1();
                    m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(this.mUser.toAndroidPerson());
                } else {
                    NotificationCompat$$ExternalSyntheticApiModelOutline0.m51m$1();
                    m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(this.mUser.getName());
                }
                Iterator<Message> it = this.mMessages.iterator();
                while (it.hasNext()) {
                    m.addMessage(it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        m.addHistoricMessage(it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    m.setConversationTitle(this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    m.setGroupConversation(this.mIsGroupConversation.booleanValue());
                }
                m.setBuilder(notificationBuilderWithBuilderAccessor.getBuilder());
                return;
            }
        ...
        public static final class Message {
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            build = Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m27m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
            ...
            Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(getText(), getTimestamp(), person != null ? person.toAndroidPerson() : null);
                } else {
                    NotificationCompat$$ExternalSyntheticApiModelOutline0.m$2();
                    m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(getText(), getTimestamp(), person != null ? person.getName() : null);
                }
                if (getDataMimeType() != null) {
                    m.setData(getDataMimeType(), getDataUri());
                }
                return m;
            }
        }
    ...
    public static class Action {
            ...
            */
            public static androidx.core.app.NotificationCompat.Action.Builder fromAndroidAction(android.app.Notification.Action r5) {
                /*
                    ...
                    r1 = 23
                    if (r0 < r1) goto L1e
                    android.graphics.drawable.Icon r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m30m(r5)
                    if (r0 == 0) goto L1e
                    android.graphics.drawable.Icon r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m30m(r5)
                ...
                L42:
                    ...
                    r2 = 24
                    if (r0 < r2) goto L4e
                    boolean r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m44m(r5)
                    r1.mAllowGeneratedReplies = r0
                L4e:
                    int r0 = android.os.Build.VERSION.SDK_INT
                    r2 = 28
                    if (r0 < r2) goto L5b
                    int r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m(r5)
                    r1.setSemanticAction(r0)
                L5b:
                    int r0 = android.os.Build.VERSION.SDK_INT
                    r2 = 29
                    if (r0 < r2) goto L68
                    boolean r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m$1(r5)
                    r1.setContextual(r0)
                L68:
                    int r0 = android.os.Build.VERSION.SDK_INT
                    r2 = 31
                    if (r0 < r2) goto L75
                    boolean r5 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m$2(r5)
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m53clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                builder = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(iconCompat == null ? null : iconCompat.toIcon(), action.getTitle(), action.getActionIntent());
            } else {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m54clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (icon == null && action.icon != 0) {
                return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z4, i4, z5, z2, z3);
            }
            ...
            return new Action(iconCompat, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z4, i4, z5, z2, z3);
        }
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z4, i4, z5, z2, z3);
    }
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m27m(it.next())));
                }
            }
        } else {
    ...
    */
    public static androidx.core.content.LocusIdCompat getLocusId(android.app.Notification r3) {
        /*
            ...
            r2 = 0
            if (r0 < r1) goto L12
            android.content.LocusId r3 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m28m(r3)
            if (r3 != 0) goto Le
            goto L12
        Le:
