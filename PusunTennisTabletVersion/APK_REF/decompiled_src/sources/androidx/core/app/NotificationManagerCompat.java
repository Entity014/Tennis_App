...
public final class NotificationManagerCompat {
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup m26m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m26m((Object) it.next());
                id = m26m.getId();
                if (id.equals(str)) {
                    return m26m;
                }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) it.next())));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup m26m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m26m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(m26m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(m26m, notificationChannels));
                    }
                }
                return arrayList;
            }
