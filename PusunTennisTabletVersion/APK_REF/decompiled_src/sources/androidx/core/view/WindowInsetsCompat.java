...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m130m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m130m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m130m = HalfKt$$ExternalSyntheticApiModelOutline0.m131m(windowInsets);
            } else {
                m130m = HalfKt$$ExternalSyntheticApiModelOutline0.m130m();
            }
            this.mPlatBuilder = m130m;
        }
