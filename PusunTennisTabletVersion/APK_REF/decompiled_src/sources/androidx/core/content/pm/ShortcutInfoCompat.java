...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo build;
        ColorKt$$ExternalSyntheticApiModelOutline0.m79m();
        shortLabel = NotificationCompat$$ExternalSyntheticApiModelOutline0.m29m(this.mContext, this.mId).setShortLabel(this.mLabel);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, ColorKt$$ExternalSyntheticApiModelOutline0.m((Object) it.next())).build());
        }
        return arrayList;
    }
