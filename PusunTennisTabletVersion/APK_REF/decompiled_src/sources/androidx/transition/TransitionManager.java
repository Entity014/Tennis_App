...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo172clone = transition.mo172clone();
        mo172clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo172clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo172clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo172clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo172clone = transition.mo172clone();
        sceneChangeSetup(viewGroup, mo172clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo172clone);
    }
