...
public class DeviceRvAdapter extends RecyclerView.Adapter<DeviceRvAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT5") || com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT6") || com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PA6")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.smart_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT0") && com.pusun.pusuntennis.utils.Util.getDeviceVersion(bleDevice) > 240712) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.smart_lite_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT9")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.mini_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PP9")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.ppmini_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PM6")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.pt_minipro_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PA8")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.smartpro_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PR1")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.smartpri_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PA9")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.smartpro_pp));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PM8")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.pp_minipro_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PM1")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.ptmax_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PM2")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.ptmax_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PM3")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.ptmax_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PP6")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.ppsmart_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PP3")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.pp8001_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PU3")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.pp8001_series));
        }
        if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT4")) {
            viewHolder.title.setText(this.context.getResources().getString(R.string.ptsmart_padel_series));
        }
        viewHolder.name.setText(com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice));
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.adapter.DeviceRvAdapter.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT5")) {
                ...
                if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT2")) {
                ...
                if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT6")) {
                ...
                if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PA6")) {
                ...
                } else if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT7") || com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT8")) {
                ...
                } else if (com.pusun.pusuntennis.utils.Util.getDeviceName(bleDevice).startsWith("PT4")) {
