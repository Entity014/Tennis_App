...
public class MainActivityPP extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] veloNums = {125, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, TsExtractor.TS_STREAM_TYPE_E_AC3, 140, 145, 150, 155, 160, 170, 180, 200, 220, 250};
    ...
    static /* synthetic */ int access$1612(MainActivityPP mainActivityPP, int i) {
        int i2 = mainActivityPP.ud + i;
        mainActivityPP.ud = i2;
        return i2;
    }

    static /* synthetic */ int access$1620(MainActivityPP mainActivityPP, int i) {
        int i2 = mainActivityPP.ud - i;
        mainActivityPP.ud = i2;
        return i2;
    }

    static /* synthetic */ int access$1712(MainActivityPP mainActivityPP, int i) {
        int i2 = mainActivityPP.lr + i;
        mainActivityPP.lr = i2;
        return i2;
    }

    static /* synthetic */ int access$1720(MainActivityPP mainActivityPP, int i) {
        int i2 = mainActivityPP.lr - i;
        mainActivityPP.lr = i2;
        return i2;
    }

    static /* synthetic */ int access$5708(MainActivityPP mainActivityPP) {
        int i = mainActivityPP.connNum;
        mainActivityPP.connNum = i + 1;
        return i;
    }

    static /* synthetic */ int access$6308(MainActivityPP mainActivityPP) {
        int i = mainActivityPP.isFaultOn;
        mainActivityPP.isFaultOn = i + 1;
        return i;
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.root_layout), new OnApplyWindowInsetsListener() { // from class: com.pusun.pusuntennis.MainActivityPP$$ExternalSyntheticLambda0
            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return MainActivityPP.lambda$onCreate$0(view, windowInsetsCompat);
            }
        });
        ...
        this.machine = (ImageView) findViewById(R.id.machine);
        this.adju = (Button) findViewById(R.id.adju);
        ...
        this.adju.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                MainActivityPP.this.showAdjust();
            }
        });
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.2
            @Override // java.lang.Runnable
            public synchronized void run() {
                MainActivityPP.this.getUrlTxt();
            }
        }, 1000L);
        ...
        this.spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.pusun.pusuntennis.MainActivityPP.3
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long j) {
                if (i == 1) {
                    MainActivityPP mainActivityPP = MainActivityPP.this;
                    mainActivityPP.showPos(mainActivityPP.gr1);
                    return;
                }
                if (i == 2) {
                    MainActivityPP mainActivityPP2 = MainActivityPP.this;
                    mainActivityPP2.showPos(mainActivityPP2.gr2);
                    return;
                }
                if (i == 3) {
                    MainActivityPP mainActivityPP3 = MainActivityPP.this;
                    mainActivityPP3.showPos(mainActivityPP3.gr3);
                    return;
                }
                if (i == 4) {
                    MainActivityPP mainActivityPP4 = MainActivityPP.this;
                    mainActivityPP4.showPos(mainActivityPP4.gr4);
                    return;
                }
                if (i == 5) {
                    MainActivityPP mainActivityPP5 = MainActivityPP.this;
                    mainActivityPP5.showPos(mainActivityPP5.gr5);
                    return;
                }
                if (i == 6) {
                    MainActivityPP mainActivityPP6 = MainActivityPP.this;
                    mainActivityPP6.showPos(mainActivityPP6.gr6);
                    return;
                }
                if (i == 7) {
                    MainActivityPP mainActivityPP7 = MainActivityPP.this;
                    mainActivityPP7.showPos(mainActivityPP7.gr7);
                    return;
                }
                if (i == 8) {
                    MainActivityPP mainActivityPP8 = MainActivityPP.this;
                    mainActivityPP8.showPos(mainActivityPP8.gr8);
                    return;
                }
                if (i == 9) {
                    MainActivityPP mainActivityPP9 = MainActivityPP.this;
                    mainActivityPP9.showPos(mainActivityPP9.gr9);
                    return;
                }
                if (i == 10) {
                    MainActivityPP mainActivityPP10 = MainActivityPP.this;
                    mainActivityPP10.showPos(mainActivityPP10.gr10);
                } else if (i == 11) {
                    MainActivityPP mainActivityPP11 = MainActivityPP.this;
                    mainActivityPP11.showPos(mainActivityPP11.gr11);
                } else if (i == 12) {
                    MainActivityPP mainActivityPP12 = MainActivityPP.this;
                    mainActivityPP12.showPos(mainActivityPP12.gr12);
                } else {
                    MainActivityPP mainActivityPP13 = MainActivityPP.this;
                    mainActivityPP13.showPos(mainActivityPP13.poids);
                }
            }
        });
        ...
        this.d_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivityPP.4
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (action == 0) {
                    ...
                    AppLog.e("up:1");
                    if (MainActivityPP.this.ud >= 1410) {
                        MainActivityPP.access$1612(MainActivityPP.this, 30);
                    }
                    if (MainActivityPP.this.ud < 1410) {
                        MainActivityPP.access$1612(MainActivityPP.this, 50);
                    }
                    if (MainActivityPP.this.ud < 1110) {
                        MainActivityPP.this.ud = 1110;
                    }
                    if (MainActivityPP.this.ud > 1830) {
                        MainActivityPP.this.ud = 1830;
                    }
                    short s = (short) MainActivityPP.this.lr;
                    if (MainActivityPP.this.modeNum == 2) {
                        s = 0;
                    }
                    short s2 = (short) MainActivityPP.this.ud;
                    if (MainActivityPP.this.modeNum == 3) {
                        s2 = 0;
                    }
                    MainActivityPP.this.writeBleData(new byte[]{-86, 108, (byte) (s >> 8), (byte) s, (byte) (s2 >> 8), (byte) s2, 0, 0, 1, -91});
                    MainActivityPP.this.num_lr.setText("" + (70 - (MainActivityPP.this.lr / 30)));
                    if (MainActivityPP.this.ud > 1410) {
                        MainActivityPP.this.num_ud.setText("" + (64 - (MainActivityPP.this.ud / 30)));
                    } else {
                        MainActivityPP.this.num_ud.setText("" + (((1410 - MainActivityPP.this.ud) / 50) + 17));
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.4.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.4.2
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                        }
                    }, 1L);
                    ...
                    AppLog.e("touch up1");
                    MainActivityPP.this.isTouch = false;
                    if (MainActivityPP.this.timeCount1 != null) {
                        MainActivityPP.this.timeCount1.cancel();
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.4.3
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            if (MainActivityPP.this.timeCount1 != null) {
                                MainActivityPP.this.timeCount1.cancel();
        ...
        this.u_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivityPP.5
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action == 0) {
                    ...
                    AppLog.e("down:1");
                    if (MainActivityPP.this.ud <= 1410) {
                        MainActivityPP.access$1620(MainActivityPP.this, 50);
                    }
                    if (MainActivityPP.this.ud > 1410) {
                        MainActivityPP.access$1620(MainActivityPP.this, 30);
                    }
                    if (MainActivityPP.this.ud < 1110) {
                        MainActivityPP.this.ud = 1110;
                    }
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.5.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.5.2
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                        }
                    }, 1L);
                    ...
                    MainActivityPP.this.isTouch = false;
                    if (MainActivityPP.this.timeCount2 != null) {
                        MainActivityPP.this.timeCount2.cancel();
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.5.3
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            if (MainActivityPP.this.timeCount2 != null) {
                                MainActivityPP.this.timeCount2.cancel();
        ...
        this.l_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivityPP.6
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action == 0) {
                    ...
                    AppLog.e("left:1");
                    MainActivityPP.access$1712(MainActivityPP.this, 30);
                    if (MainActivityPP.this.lr < 1140) {
                        MainActivityPP.this.lr = 1140;
                    }
                    if (MainActivityPP.this.lr > 2040) {
                        MainActivityPP.this.lr = 2040;
                    }
                    short s = (short) MainActivityPP.this.lr;
                    if (MainActivityPP.this.modeNum == 2) {
                        s = 0;
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.6.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.6.2
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                        }
                    }, 1L);
                    ...
                    MainActivityPP.this.isTouch = false;
                    if (MainActivityPP.this.timeCount3 != null) {
                        MainActivityPP.this.timeCount3.cancel();
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.6.3
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            if (MainActivityPP.this.timeCount3 != null) {
                                MainActivityPP.this.timeCount3.cancel();
        ...
        this.ri_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivityPP.7
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action == 0) {
                    ...
                    AppLog.e("right:1");
                    MainActivityPP.access$1720(MainActivityPP.this, 30);
                    if (MainActivityPP.this.lr < 1140) {
                        MainActivityPP.this.lr = 1140;
                    }
                    if (MainActivityPP.this.lr > 2040) {
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.7.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.7.2
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                        }
                    }, 1L);
                    ...
                    MainActivityPP.this.isTouch = false;
                    if (MainActivityPP.this.timeCount4 != null) {
                        MainActivityPP.this.timeCount4.cancel();
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.7.3
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            if (MainActivityPP.this.timeCount4 != null) {
                                MainActivityPP.this.timeCount4.cancel();
        ...
        this.change_point.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                MainActivityPP.this.writeBleData(new byte[]{-86, 112, 3, Ascii.SYN, 5, Ascii.FF, 1, 0, 1, -91});
            }
        });
        this.change_get.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                MainActivityPP.this.writeBleData(new byte[]{-86, 113, 0, 0, 0, 0, 0, 0, 1, -91});
            }
        });
        IndicatorSeekBar indicatorSeekBar = (IndicatorSeekBar) findViewById(R.id.freq);
        this.freq = indicatorSeekBar;
        indicatorSeekBar.setOnSeekChangeListener(new OnSeekChangeListener() { // from class: com.pusun.pusuntennis.MainActivityPP.10
            ...
            public void onStopTrackingTouch(IndicatorSeekBar indicatorSeekBar2) {
                ...
                MainActivityPP.this.f_tv.setText("" + progress);
                if (MainActivityPP.this.btn_ball.getText().toString().equals(MainActivityPP.this.getResources().getString(R.string.stop))) {
                    int i = progress - 1;
                    MainActivityPP.this.writeBleData(new byte[]{-86, 97, (byte) MainActivityPP.this.frequentNums[i], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.frequentNums[i] ^ 97), -91});
                }
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.10.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
        ...
        this.freqde.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.11
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                int intValue = Integer.valueOf(MainActivityPP.this.f_tv.getText().toString().trim()).intValue();
                if (intValue > 1) {
                    int i = intValue - 1;
                    MainActivityPP.this.f_tv.setText("" + i);
                    MainActivityPP.this.freq.setProgress((float) i);
                    int i2 = intValue + (-2);
                    MainActivityPP.this.writeBleData(new byte[]{-86, 97, (byte) MainActivityPP.this.frequentNums[i2], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.frequentNums[i2] ^ 97), -91});
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.11.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
        ...
        this.freqadd.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.12
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                int intValue = Integer.valueOf(MainActivityPP.this.f_tv.getText().toString().trim()).intValue();
                if (intValue < 10) {
                    ...
                    MainActivityPP.this.f_tv.setText("" + i);
                    MainActivityPP.this.freq.setProgress((float) i);
                    MainActivityPP.this.writeBleData(new byte[]{-86, 97, (byte) MainActivityPP.this.frequentNums[intValue], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.frequentNums[intValue] ^ 97), -91});
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.12.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
        ...
        indicatorSeekBar2.setOnSeekChangeListener(new OnSeekChangeListener() { // from class: com.pusun.pusuntennis.MainActivityPP.13
            @Override // com.warkiz.widget.OnSeekChangeListener
            public void onSeeking(SeekParams seekParams) {
            }
            ...
            public void onStopTrackingTouch(IndicatorSeekBar indicatorSeekBar3) {
                ...
                if (MainActivityPP.this.modeCate == 0 && MainActivityPP.this.modeNum == 8) {
                ...
                if (progress != 0 && MainActivityPP.this.velobar.getProgress() < 5) {
                    MainActivityPP.this.velobar.setProgress(5.0f);
                    MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[4], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[4] ^ 99), -91});
                    MainActivityPP.this.v_tv.setText("" + MainActivityPP.this.veloTins[4]);
                }
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.13.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
                ...
                if (progress < 0) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.13.2
                        @Override // java.lang.Runnable
                        public void run() {
                            int i = progress;
                            MainActivityPP.this.writeBleData(new byte[]{-86, 98, 2, (byte) ((-i) * 5), 0, 0, 0, 0, (byte) (((-i) * 5) ^ 96), -91});
                        }
                    }, 100L);
                }
                if (progress > 0) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.13.3
                        @Override // java.lang.Runnable
                        public void run() {
                            int i = progress;
                            MainActivityPP.this.writeBleData(new byte[]{-86, 98, 1, (byte) (i * 5), 0, 0, 0, 0, (byte) ((i * 5) ^ 99), -91});
                        }
                    }, 100L);
                }
                if (progress == 0) {
                    MainActivityPP.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 98, -91});
                }
                MainActivityPP.this.r_tv.setText("" + progress);
            }
        });
        IndicatorSeekBar indicatorSeekBar3 = (IndicatorSeekBar) findViewById(R.id.velobar);
        this.velobar = indicatorSeekBar3;
        indicatorSeekBar3.setOnSeekChangeListener(new OnSeekChangeListener() { // from class: com.pusun.pusuntennis.MainActivityPP.14
            @Override // com.warkiz.widget.OnSeekChangeListener
            public void onSeeking(SeekParams seekParams) {
            }
            ...
            public void onStopTrackingTouch(IndicatorSeekBar indicatorSeekBar4) {
                if (MainActivityPP.this.forbid == 1) {
                    MainActivityPP mainActivityPP = MainActivityPP.this;
                    ShowHelper.showAlertDialog(mainActivityPP, mainActivityPP.getResources().getString(R.string.alert), MainActivityPP.this.getResources().getString(R.string.forbid_alert));
                    return;
                }
                int progress = indicatorSeekBar4.getProgress();
                if (MainActivityPP.this.modeCate == 0 && MainActivityPP.this.modeNum == 5 && progress > 6) {
                    indicatorSeekBar4.setProgress(6.0f);
                    progress = 6;
                }
                TextView textView12 = MainActivityPP.this.v_tv;
                StringBuilder sb = new StringBuilder("");
                int i = progress - 1;
                sb.append(MainActivityPP.this.veloTins[i]);
                textView12.setText(sb.toString());
                if (progress < 5 && MainActivityPP.this.rotatebar.getProgress() != 0) {
                    MainActivityPP.this.r_tv.setText("0");
                    MainActivityPP.this.rotatebar.setProgress(0.0f);
                    MainActivityPP.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 98, -91});
                }
                MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[i], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[i] ^ 99), -91});
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.14.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
        ...
        this.spde.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.15
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (MainActivityPP.this.forbid != 1) {
                    int progress = MainActivityPP.this.velobar.getProgress();
                    if (progress > 1) {
                        int i = progress - 1;
                        TextView textView12 = MainActivityPP.this.v_tv;
                        StringBuilder sb = new StringBuilder("");
                        int i2 = progress - 2;
                        sb.append(MainActivityPP.this.veloTins[i2]);
                        textView12.setText(sb.toString());
                        MainActivityPP.this.velobar.setProgress(i);
                        if (i < 4 && MainActivityPP.this.rotatebar.getProgress() != 0) {
                            MainActivityPP.this.r_tv.setText("0");
                            MainActivityPP.this.rotatebar.setProgress(0.0f);
                            MainActivityPP.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 98, -91});
                        }
                        MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[i2], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[i2] ^ 99), -91});
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.15.1
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                            }
        ...
        this.spadd.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.16
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (MainActivityPP.this.forbid != 1) {
                    int progress = MainActivityPP.this.velobar.getProgress();
                    if (progress < 13) {
                        int i = progress + 1;
                        MainActivityPP.this.v_tv.setText("" + MainActivityPP.this.veloTins[progress]);
                        MainActivityPP.this.velobar.setProgress((float) i);
                        if (i < 4 && MainActivityPP.this.rotatebar.getProgress() != 0) {
                            MainActivityPP.this.r_tv.setText("0");
                            MainActivityPP.this.rotatebar.setProgress(0.0f);
                            MainActivityPP.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 98, -91});
                        }
                        MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[progress], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[progress] ^ 99), -91});
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.16.1
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                            }
        ...
        this.switchbtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.pusun.pusuntennis.MainActivityPP.17
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
                    MainActivityPP.this.self.setVisibility(8);
                    MainActivityPP.this.group.setVisibility(0);
                    MainActivityPP.this.points.setVisibility(0);
                    MainActivityPP.this.hintpoints.setVisibility(0);
                    MainActivityPP.this.group_cate.setVisibility(0);
                    MainActivityPP.this.tennipic2.setVisibility(8);
                    MainActivityPP.this.tennipic3.setVisibility(8);
                    MainActivityPP.this.tennipic4.setVisibility(8);
                    MainActivityPP.this.tennipic5.setVisibility(8);
                    MainActivityPP.this.fourbtn.setVisibility(8);
                    MainActivityPP.this.bg_four.setVisibility(8);
                    MainActivityPP.this.bg_input.setVisibility(0);
                    RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) MainActivityPP.this.start_layout.getLayoutParams();
                    layoutParams.height = (int) (MainActivityPP.this.density * 36.0f);
                    MainActivityPP.this.start_layout.setLayoutParams(layoutParams);
                    MainActivityPP.this.start_layout.setGravity(17);
                    MainActivityPP.this.modeCate = 1;
                    return;
                }
                MainActivityPP.this.self.setVisibility(0);
                MainActivityPP.this.group.setVisibility(8);
                MainActivityPP.this.points.setVisibility(8);
                MainActivityPP.this.hintpoints.setVisibility(8);
                MainActivityPP.this.tennipic2.setVisibility(0);
                MainActivityPP.this.bg_input.setVisibility(8);
                MainActivityPP.this.group_cate.setVisibility(8);
                RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) MainActivityPP.this.start_layout.getLayoutParams();
                layoutParams2.height = (int) (MainActivityPP.this.density * 90.0f);
                MainActivityPP.this.start_layout.setLayoutParams(layoutParams2);
                MainActivityPP.this.start_layout.setGravity(83);
                MainActivityPP.this.fourbtn.setVisibility(0);
                MainActivityPP.this.bg_four.setVisibility(0);
                if (MainActivityPP.this.modeNum == 2) {
                    MainActivityPP.this.tennipic3.setVisibility(0);
                    MainActivityPP.this.tennipic4.setVisibility(8);
                    MainActivityPP.this.tennipic5.setVisibility(8);
                }
                if (MainActivityPP.this.modeNum == 3) {
                    MainActivityPP.this.tennipic3.setVisibility(8);
                    MainActivityPP.this.tennipic4.setVisibility(0);
                    MainActivityPP.this.tennipic5.setVisibility(8);
                }
                if (MainActivityPP.this.modeNum == 4) {
                    MainActivityPP.this.tennipic3.setVisibility(8);
                    MainActivityPP.this.tennipic4.setVisibility(8);
                    MainActivityPP.this.tennipic5.setVisibility(0);
                }
                MainActivityPP.this.modeCate = 0;
            }
        });
        this.blenoty.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.18
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (MainActivityPP.this.blenoty.getText().toString().trim().contains(MainActivityPP.this.getResources().getString(R.string.disconnected))) {
                    ...
                    MainActivityPP.this.blenoty.setBackground(MainActivityPP.this.getResources().getDrawable(R.drawable.button_stop_selector));
                }
            }
        });
        this.rgheight.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.pusun.pusuntennis.MainActivityPP.19
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    case R.id.radio0 /* 2131362353 */:
                        MainActivityPP.this.radioNum = 0;
                        MainActivityPP.this.sendBaseData(0);
                        break;
                    case R.id.radio1 /* 2131362354 */:
                        MainActivityPP.this.radioNum = 1;
                        MainActivityPP.this.sendBaseData(1);
                        break;
                    case R.id.radio2 /* 2131362355 */:
                        MainActivityPP.this.radioNum = 2;
                        MainActivityPP.this.sendBaseData(2);
                        break;
                }
            }
        });
    ...
    public void showAdjust() {
        ...
        dialog.setContentView(View.inflate(this, R.layout.adjust_layout, null));
        Window window = dialog.getWindow();
        window.setGravity(17);
        window.setWindowAnimations(R.style.main_menu_animStyle);
        window.setLayout(-2, -2);
        dialog.show();
        dialog.findViewById(R.id.conf).setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.20
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                dialog.dismiss();
            }
    ...
    public void getUrlTxt() {
        new Thread(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.21
            @Override // java.lang.Runnable
            public void run() {
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            Looper.prepare();
                            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.21.1
                                @Override // java.lang.Runnable
                                public synchronized void run() {
                                    ...
                                    while (true) {
                                        if (i < split.length) {
                                            if (com.pusun.pusuntennis.utils.Util.getDeviceName(MainActivityPP.bleDevice).equals(split[i].toString().trim())) {
                                                ...
                                                edit.commit();
                                                SharedPreferences sharedPreferences = MainActivityPP.this.getSharedPreferences(MainActivityPP.FORBID_INFO, 0);
                                                AppLog.e("" + sharedPreferences.getInt(MainActivityPP.FORBID_INFO, 0));
                                                MainActivityPP.this.forbid = sharedPreferences.getInt(MainActivityPP.FORBID_INFO, 0);
                                                break;
                                            }
                                            i++;
                                        } else {
                                            SharedPreferences.Editor edit2 = MainActivityPP.this.getSharedPreferences(MainActivityPP.FORBID_INFO, 0).edit();
                                            edit2.putInt(MainActivityPP.FORBID_INFO, 0);
                                            edit2.commit();
                                            SharedPreferences sharedPreferences2 = MainActivityPP.this.getSharedPreferences(MainActivityPP.FORBID_INFO, 0);
                                            AppLog.e("" + sharedPreferences2.getInt(MainActivityPP.FORBID_INFO, 0));
                                            MainActivityPP.this.forbid = sharedPreferences2.getInt(MainActivityPP.FORBID_INFO, 0);
                                            break;
                                        }
                                    }
                                }
    ...
    private void sendBaseData() {
        ...
        while (i < BasicData2.b2.length) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.22
                @Override // java.lang.Runnable
                public synchronized void run() {
                    AppLog.e("第" + final_i + "条指令");
                    MainActivityPP.this.writeBleData(bArr);
                }
            }, (long) (i * 10));
            i = i2;
        }
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.23
            @Override // java.lang.Runnable
            public synchronized void run() {
                int i3 = 10;
        while (i3 < BasicData2.b2.length) {
            final int final_i3 = i3;
                    ...
                    AppLog.e("左右：" + ((int) BasicData2.b2[i3][0]) + "上下：" + ((int) BasicData2.b2[i3][1]) + "byte:" + MainActivityPP.bytesToHexString(bArr2));
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.23.1
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            AppLog.e("第" + final_i3 + "条指令");
                            MainActivityPP.this.writeBleData(bArr2);
                        }
                    }, (long) (i3 * 10));
                    i3 = i4;
                }
    ...
    public void sendBaseData(int i) {
        ...
        while (i2 < BasicData2.b3.length) {
            final int final_i2 = i2;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.24
                    @Override // java.lang.Runnable
                    public synchronized void run() {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.25
                @Override // java.lang.Runnable
                public synchronized void run() {
                    int i4 = 10;
        while (i4 < BasicData2.b3.length) {
            final int final_i4 = i4;
                        ...
                        AppLog.e("左右：" + ((int) BasicData2.b3[i4][0]) + "上下：" + ((int) BasicData2.b3[i4][1]) + "byte:" + MainActivityPP.bytesToHexString(bArr2));
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.25.1
                            @Override // java.lang.Runnable
                            public synchronized void run() {
        ...
        while (i4 < BasicData2.b4.length) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.26
                @Override // java.lang.Runnable
                public synchronized void run() {
                    AppLog.e("第" + final_i4 + "条指令");
                    MainActivityPP.this.writeBleData(bArr2);
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.27
            @Override // java.lang.Runnable
            public synchronized void run() {
                int i6 = 10;
        while (i6 < BasicData2.b4.length) {
            final int final_i6 = i6;
                    ...
                    AppLog.e("左右：" + ((int) BasicData2.b4[i6][0]) + "上下：" + ((int) BasicData2.b4[i6][1]) + "byte:" + MainActivityPP.bytesToHexString(bArr3));
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.27.1
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            AppLog.e("第" + final_i6 + "条指令");
                            MainActivityPP.this.writeBleData(bArr3);
                        }
                    }, (long) (i6 * 10));
                    i6 = i7;
                }
    ...
    public void writeBleData(byte[] bArr) {
        ...
        if (str != null && (str.startsWith("PP0") || this.nameStar.startsWith("PP1"))) {
            BleManager.getInstance().write(bleDevice, BLEServiceParameters.BLE_WRITE_SERVICE_UUIDA, BLEServiceParameters.BLE_WRITE_SERVICE_CHARACTER_UUIDA, bArr, new BleWriteCallback() { // from class: com.pusun.pusuntennis.MainActivityPP.28
                ...
                public void onWriteSuccess(int i, int i2, byte[] bArr2) {
                    MainActivityPP mainActivityPP = MainActivityPP.this;
                    ShowHelper.toastShort(mainActivityPP, mainActivityPP.getResources().getString(R.string.order_executed));
                }
            });
        }
        String str2 = this.nameStar;
        if (str2 != null) {
            if (str2.startsWith("PP2") || this.nameStar.startsWith("PP3") || this.nameStar.startsWith("PP4") || this.nameStar.startsWith("PP9")) {
                BleManager.getInstance().write(bleDevice, BLEServiceParameters.BLE_WRITE_SERVICE_UUID, BLEServiceParameters.BLE_WRITE_SERVICE_CHARACTER_UUID, bArr, new BleWriteCallback() { // from class: com.pusun.pusuntennis.MainActivityPP.29
                    @Override // com.clj.fastble.callback.BleWriteCallback
                    public void onWriteFailure(BleException bleException) {
                    }
    ...
    public void startScan() {
        BleManager.getInstance().scan(new BleScanCallback() { // from class: com.pusun.pusuntennis.MainActivityPP.30
            @Override // com.clj.fastble.callback.BleScanPresenterImp
            public void onScanStarted(boolean z) {
                MainActivityPP mainActivityPP = MainActivityPP.this;
                ShowHelper.showProgressDialog(mainActivityPP, mainActivityPP.getResources().getString(R.string.scanning));
            }
            ...
            public void onScanFinished(List<BleDevice> list) {
                if (list == null || list.size() == 0) {
                    ...
                    MainActivityPP mainActivityPP = MainActivityPP.this;
                    ShowHelper.toastLong(mainActivityPP, mainActivityPP.getResources().getString(R.string.no_device_found));
                    if (MainActivityPP.this.connNum < 3) {
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.30.1
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivityPP.this.startScan();
                            }
                        }, 1000L);
                        MainActivityPP.access$5708(MainActivityPP.this);
                        return;
                    }
                    return;
                }
                ...
                if (list.size() == 1 && list.get(0).getName() != null && list.get(0).getName().startsWith("PP")) {
                    MainActivityPP.this.connect(list.get(0));
                    return;
                }
                ...
                if (arrayList.size() == 0) {
                    MainActivityPP mainActivityPP2 = MainActivityPP.this;
                    ShowHelper.toastLong(mainActivityPP2, mainActivityPP2.getResources().getString(R.string.no_device_found));
                    if (MainActivityPP.this.connNum < 3) {
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.30.2
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivityPP.this.startScan();
                            }
                ...
                if (arrayList.size() == 1) {
                    MainActivityPP.this.connect((BleDevice) arrayList.get(0));
                    return;
                }
                ...
                OptionPicker optionPicker = new OptionPicker(MainActivityPP.this, strArr);
                optionPicker.setOffset(2);
                optionPicker.setSelectedIndex(0);
                optionPicker.setTextSize(18);
                optionPicker.setTitleText(MainActivityPP.this.getResources().getString(R.string.select_device));
                optionPicker.setCancelText(MainActivityPP.this.getResources().getString(R.string.cancel));
                optionPicker.setSubmitText(MainActivityPP.this.getResources().getString(R.string.submit));
                optionPicker.setOnOptionPickListener(new OptionPicker.OnOptionPickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.30.3
                    @Override // cn.qqtheme.framework.picker.OptionPicker.OnOptionPickListener
                    public void onOptionPicked(String str) {
                        for (int i3 = 0; i3 < arrayList.size(); i3++) {
                            if (((BleDevice) arrayList.get(i3)).getName().equals(str)) {
                                MainActivityPP.this.connect((BleDevice) arrayList.get(i3));
                                return;
                            }
                        }
                    }
            ...
            if (mac != null) {
                BleManager.getInstance().connect(mac, new BleGattCallback() {
                    ...
                    public void onStartConnect() {
                        MainActivityPP mainActivity = MainActivityPP.this;
                    ...
                    public void onConnectFail(BleDevice bleDevice3, BleException bleException) {
                        ...
                        MainActivityPP.this.blenoty.setText(MainActivityPP.this.getResources().getString(R.string.disconnected));
                        MainActivityPP.this.blenoty.setBackground(MainActivityPP.this.getResources().getDrawable(R.drawable.button_stop_selector));
                        MainActivityPP.this.signal.setBackground(MainActivityPP.this.getResources().getDrawable(R.drawable.bicon_gray));
                        MainActivityPP.this.signal_note.setText(MainActivityPP.this.getResources().getString(R.string.device_is_disconnect));
                        MainActivityPP.this.signal_note.setTextColor(MainActivityPP.this.getResources().getColor(R.color.icon_gray));
                        BleManager.getInstance().disconnectAllDevice();
                    }
                    @Override
                    public void onConnectSuccess(BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ShowHelper.setProgressDialogMessage(MainActivityPP.this.getResources().getString(R.string.initializing));
                        MainActivityPP.this.connNum = 0;
                        ...
                        if (resolvedName == null || resolvedName.isEmpty()) resolvedName = MainActivityPP.this.deviceName != null ? MainActivityPP.this.deviceName : "";
                        MainActivityPP.this.nameStar = resolvedName;
                        ...
                        MainActivityPP.this.signal_note.setTextColor(MainActivityPP.this.getResources().getColor(R.color.icon_green));
                        MainActivityPP.this.signal.setBackground(MainActivityPP.this.getResources().getDrawable(R.drawable.bicon_blue));
                        MainActivityPP.this.isFaultOn = 0;
                        MainActivityPP.this.gatt = bluetoothGatt;
                        MainActivityPP.bleDevice = bleDevice3;
                        if (bleDevice3.getMac() != null) MainActivityPP.this.deviceMac = bleDevice3.getMac();
                        MainActivityPP.this.startNotify();
                    }
                    @Override
                    public void onDisConnected(boolean z, final BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ...
                        BleManager.getInstance().disconnectAllDevice();
                        MainActivityPP.this.isFaultOn = 0;
                        if (z || MainActivityPP.this.connNum >= 3) { return; }
                        new android.os.Handler().postDelayed(new Runnable() {
                            @Override public void run() { MainActivityPP.this.connect(bleDevice3); }
                        }, 1000L);
                    }
                });
            } else {
                android.util.Log.e("MainActivityPP", "connect: bleDevice and mac are both null, cannot connect");
            }
            return;
        }
        BleManager.getInstance().connect(bleDevice2, new BleGattCallback() { // from class: com.pusun.pusuntennis.MainActivityPP.31
            @Override // com.clj.fastble.callback.BleGattCallback
            public void onStartConnect() {
                MainActivityPP mainActivityPP = MainActivityPP.this;
                ShowHelper.showProgressDialog(mainActivityPP, mainActivityPP.getResources().getString(R.string.connecting_device));
            }

            @Override // com.clj.fastble.callback.BleGattCallback
            public void onConnectFail(final BleDevice bleDevice3, BleException bleException) {
                MainActivityPP mainActivityPP = MainActivityPP.this;
                ShowHelper.toastLong(mainActivityPP, mainActivityPP.getResources().getString(R.string.connect_failure_check));
                ShowHelper.dismissProgressDialog();
                MainActivityPP.this.blenoty.setText(MainActivityPP.this.getResources().getString(R.string.disconnected));
                MainActivityPP.this.blenoty.setBackground(MainActivityPP.this.getResources().getDrawable(R.drawable.button_stop_selector));
                MainActivityPP.this.signal.setBackground(MainActivityPP.this.getResources().getDrawable(R.drawable.bicon_gray));
                ...
                MainActivityPP.this.signal_note.setTextColor(MainActivityPP.this.getResources().getColor(R.color.icon_gray));
                BleManager.getInstance().disconnectAllDevice();
                if (MainActivityPP.this.connNum >= 3 || bleDevice3 == null) {
                    return;
                }
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.31.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.connect(bleDevice3);
                    }
                }, 1000L);
                MainActivityPP.access$5708(MainActivityPP.this);
            }
            ...
            public void onConnectSuccess(BleDevice bleDevice3, BluetoothGatt bluetoothGatt, int i) {
                ShowHelper.setProgressDialogMessage(MainActivityPP.this.getResources().getString(R.string.initializing));
                MainActivityPP.this.connNum = 0;
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.31.2
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        ShowHelper.dismissProgressDialog();
                        ShowHelper.toastShort(MainActivityPP.this, MainActivityPP.this.getResources().getString(R.string.please_use));
                ...
                if (rawNameMainAc == null || rawNameMainAc.isEmpty()) rawNameMainAc = MainActivityPP.this.deviceName != null ? MainActivityPP.this.deviceName : "";
                MainActivityPP.this.nameStar = rawNameMainAc;
                MainActivityPP.this.blenoty.setText(MainActivityPP.this.getResources().getString(R.string.connected));
                MainActivityPP.this.blenoty.setBackground(MainActivityPP.this.getResources().getDrawable(R.drawable.button_selector));
                MainActivityPP.this.signal_note.setText(MainActivityPP.this.nameStar + MainActivityPP.this.getResources().getString(R.string.connected));
                MainActivityPP.this.signal_note.setTextColor(MainActivityPP.this.getResources().getColor(R.color.icon_green));
                ...
                MainActivityPP.this.gatt = bluetoothGatt;
                MainActivityPP.bleDevice = bleDevice3;
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.31.3
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
            ...
            public void onDisConnected(boolean z, final BleDevice bleDevice3, BluetoothGatt bluetoothGatt, int i) {
                ...
                BleManager.getInstance().disconnectAllDevice();
                MainActivityPP.this.isFaultOn = 0;
                if (z || MainActivityPP.this.connNum >= 3) {
                    return;
                }
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.31.4
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.connect(bleDevice3);
                    }
    ...
    public void startNotify() {
        String str = this.nameStar;
        if (str != null && (str.startsWith("PP0") || this.nameStar.startsWith("PP1"))) {
            BleManager.getInstance().notify(bleDevice, BLEServiceParameters.BLE_NOTIFY_SERVICE_UUIDA, BLEServiceParameters.BLE_NOTIFY_SERVICE_CHARACTERISTIC_UUIDA, new BleNotifyCallback() { // from class: com.pusun.pusuntennis.MainActivityPP.32
                ...
                public void onCharacteristicChanged(byte[] bArr) {
                    ...
                    if (bArr.length > 2 && (bArr[1] & 255) == 3) {
                        MainActivityPP.this.batteryVolumeMsg(bArr[2] & 255);
                    }
                    if (bArr.length > 2 && (bArr[1] & 255) == 94 && MainActivityPP.this.isFaultOn == 0) {
                        MainActivityPP.access$6308(MainActivityPP.this);
                        MainActivityPP.this.faultMsg(bArr[2] & 255);
                    }
                }
            });
        }
        String str2 = this.nameStar;
        if (str2 != null && (str2.startsWith("PP2") || this.nameStar.startsWith("PP3") || this.nameStar.startsWith("PP9") || this.nameStar.startsWith("PP6"))) {
            BleManager.getInstance().notify(bleDevice, BLEServiceParameters.BLE_NOTIFY_SERVICE_UUID, BLEServiceParameters.BLE_NOTIFY_SERVICE_CHARACTERISTIC_UUID, new BleNotifyCallback() { // from class: com.pusun.pusuntennis.MainActivityPP.33
                @Override // com.clj.fastble.callback.BleNotifyCallback
                public void onNotifyFailure(BleException bleException) {
                }
                ...
                public void onCharacteristicChanged(byte[] bArr) {
                    AppLog.e("notify:" + bArr.length + "指令：" + (bArr[1] & 255));
                    if (bArr.length > 2 && (bArr[1] & 255) == 3) {
                        MainActivityPP.this.batteryVolumeMsg(MainActivityPP.getShort(bArr[2], bArr[3]));
                    }
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.34
            @Override // java.lang.Runnable
            public synchronized void run() {
                MainActivityPP.this.checkPower();
            }
        }, 3600L);
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.35
            @Override // java.lang.Runnable
            public synchronized void run() {
                if (MainActivityPP.this.forbid == 1) {
                    MainActivityPP.this.writeBleData(new byte[]{-86, 99, 10, 0, 0, 0, 0, 0, 105, -91});
                }
            }
        }, 3700L);
    }
    ...
    private void onPermissionGranted(String str) {
        ...
        if (str.equals("android.permission.ACCESS_FINE_LOCATION")) {
            if (Build.VERSION.SDK_INT >= 23 && !checkGPSIsOpen()) {
                new AlertDialog.Builder(this).setTitle(getResources().getString(R.string.notice)).setMessage(getResources().getString(R.string.blue_need_setting)).setNegativeButton(getResources().getString(R.string.cancel), new DialogInterface.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.37
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                        MainActivityPP.this.finish();
                    }
                }).setPositiveButton(getResources().getString(R.string.go_setting), new DialogInterface.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivityPP.36
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                        MainActivityPP.this.startActivityForResult(new Intent("android.settings.LOCATION_SOURCE_SETTINGS"), 1);
                    }
        ...
        switch (id) {
            case R.id.btn_ball /* 2131361912 */:
                if (this.blenoty.getText().toString().equals(getResources().getString(R.string.disconnected))) {
                    ...
                    this.machine.setImageResource(R.drawable.m2);
                    if (this.forbid == 1) {
                        ShowHelper.showAlertDialog(this, getResources().getString(R.string.alert), getResources().getString(R.string.forbid_alert));
                        break;
                    } else {
                        if (this.modeCate == 0) {
                            ...
                            if (this.modeNum == 2) {
                                ...
                                if (this.stopMode != 2) {
                                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.75
                                        @Override // java.lang.Runnable
                                        public synchronized void run() {
                                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                                            MainActivityPP.this.velobar.setProgress(7.0f);
                                            MainActivityPP.this.v_tv.setText("" + MainActivityPP.this.veloTins[6]);
                                        }
                                    }, 100L);
                                }
                            }
                            if (this.modeNum == 3) {
                                ...
                                if (this.stopMode != 3) {
                                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.76
                                        @Override // java.lang.Runnable
                                        public synchronized void run() {
                                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                                            MainActivityPP.this.velobar.setProgress(7.0f);
                            ...
                            if (this.modeNum == 4) {
                                ...
                                if (this.stopMode != 4) {
                                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.77
                                        @Override // java.lang.Runnable
                                        public synchronized void run() {
                                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                                            MainActivityPP.this.velobar.setProgress(7.0f);
                            ...
                            if (this.modeNum == 5) {
                                AppLog.e("isN:" + this.isNumDing + "sM:" + this.stopMode);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.78
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                                    }
                                }, 200L);
                            }
                            if (this.modeNum == 6) {
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.79
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        int i2;
                                        int unused = MainActivityPP.this.tagC;
                                        int i3 = 15;
                                        int i4 = 11;
                                        int i5 = MainActivityPP.this.tagC == 2 ? 15 : 11;
                                        int i6 = 13;
                                        if (MainActivityPP.this.tagC == 3) {
                                            i5 = 13;
                                            i2 = 1;
                                        } else {
                                            i2 = 3;
                                        }
                                        if (MainActivityPP.this.tagC == 4) {
                                            i2 = 5;
                                        } else {
                                            i6 = i5;
                                        }
                                        if (MainActivityPP.this.tagC == 5) {
                                            i2 = 5;
                                        } else {
                                            i4 = i6;
                                        }
                                        if (MainActivityPP.this.tagC == 6) {
                                            i2 = 1;
                                        } else {
                                            i3 = i4;
                                        }
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 109, 1, (byte) i3, (byte) i2, 0, 0, 0, (byte) ((i3 ^ 108) ^ i2), -91});
                                    }
                                }, 5L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.80
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 109, 2, 0, 0, 0, 0, 0, 111, -91});
                                    }
                                }, 50L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.81
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 109, 3, 0, 0, 0, 0, 0, 110, -91});
                                    }
                                }, 80L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.82
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 109, 4, 0, 0, 0, 0, 0, 105, -91});
                                    }
                                }, 110L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.83
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 109, 5, 0, 0, 0, 0, 0, 104, -91});
                                    }
                                }, 140L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.84
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 109, 6, 0, 0, 0, 0, 0, 107, -91});
                                    }
                                }, 170L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.85
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 5, 0, 0, 0, 0, 0, 111, -91});
                                    }
                                }, 250L);
                                if (this.stopMode != 6) {
                                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.86
                                        @Override // java.lang.Runnable
                                        public synchronized void run() {
                                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                                            MainActivityPP.this.velobar.setProgress(7.0f);
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.87
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                int progress = MainActivityPP.this.velobar.getProgress() - 1;
                                MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[progress], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[progress] ^ 99), -91});
                            }
                        }, 10L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.88
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                int progress = MainActivityPP.this.freq.getProgress() - 1;
                                MainActivityPP.this.writeBleData(new byte[]{-86, 97, (byte) MainActivityPP.this.frequentNums[progress], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.frequentNums[progress] ^ 97), -91});
                            }
                        }, 1000L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.89
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivityPP.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 111, -91});
                            }
                        }, 160L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.90
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                            }
                        ...
                        this.btn_ball.setBackground(getResources().getDrawable(R.drawable.yuan_orange));
                        break;
                    }
                } else {
                    this.machine.setImageResource(R.drawable.m1);
                    this.stopMode = this.modeNum;
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.91
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 260L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.92
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.checkPower();
                        }
                    ...
                    this.signal_note.setTextColor(getResources().getColor(R.color.icon_green));
                    this.btn_ball.setBackground(getResources().getDrawable(R.drawable.yuan_green));
                    break;
                }
            ...
            case R.id.down_up /* 2131361990 */:
                ...
                hideUD();
                if (this.modeNum != 3) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.46
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                            MainActivityPP.this.velobar.setProgress(7.0f);
                ...
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.47
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    ...
                    if (this.modeCate == 0) {
                        ...
                        if (this.modeNum == 3) {
                            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.48
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (MainActivityPP.this.tagV == 1) {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 3, 0, 0, 0, 0, 0, 105, -91});
                                    }
                                    if (MainActivityPP.this.tagV == 2) {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 3, 3, 8, Ascii.CR, 0, 0, 111, -91});
                                    }
                                    if (MainActivityPP.this.tagV == 3) {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 3, 3, Ascii.CR, 0, 0, 0, 103, -91});
                                    }
                                }
                            }, 30L);
                        }
            ...
            case R.id.group_cross /* 2131362113 */:
                ...
                this.points.setVisibility(8);
                if (this.modeNum != 6) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.54
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                            MainActivityPP.this.velobar.setProgress(7.0f);
                ...
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.55
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 250L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.56
                        @Override // java.lang.Runnable
                        public void run() {
                            int i4;
                            int unused = MainActivityPP.this.tagC;
                            int i5 = 15;
                            int i6 = 11;
                            int i7 = MainActivityPP.this.tagC == 2 ? 15 : 11;
                            int i8 = 13;
                            if (MainActivityPP.this.tagC == 3) {
                                i7 = 13;
                                i4 = 1;
                            ...
                            MainActivityPP.this.writeBleData(new byte[]{-86, 109, 1, (byte) i5, (byte) i4, 0, 0, 0, (byte) ((i5 ^ 108) ^ i4), -91});
                        }
                    }, 5L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.57
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 109, 2, 0, 0, 0, 0, 0, 111, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.58
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 109, 3, 0, 0, 0, 0, 0, 110, -91});
                        }
                    }, 80L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.59
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 109, 4, 0, 0, 0, 0, 0, 105, -91});
                        }
                    }, 110L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.60
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 109, 5, 0, 0, 0, 0, 0, 104, -91});
                        }
                    }, 140L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.61
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 109, 6, 0, 0, 0, 0, 0, 107, -91});
                        }
                    }, 170L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.62
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 106, 5, 0, 0, 0, 0, 0, 111, -91});
                        }
            ...
            case R.id.high_point /* 2131362124 */:
                ...
                if (i4 != 5) {
                    ...
                    if (i4 == 1) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.49
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                ShowHelper.dismissProgressDialog();
                            }
                        }, 1300L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.50
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                ShowHelper.dismissProgressDialog();
                            }
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.51
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivityPP.this.velobar.getProgress();
                        MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[3], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[3] ^ 99), -91});
                        MainActivityPP.this.velobar.setProgress(4.0f);
                        MainActivityPP.this.v_tv.setText("" + MainActivityPP.this.veloTins[3]);
                    }
                }, 50L);
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.52
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    ...
                    if (this.modeCate == 0 && this.modeNum == 5) {
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.53
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivityPP.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                            }
            ...
            case R.id.hit /* 2131362126 */:
                ...
                this.modeCate = 0;
                changeOperate();
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.63
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[5], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[5] ^ 99), -91});
                        MainActivityPP.this.velobar.setProgress(6);
                        MainActivityPP.this.v_tv.setText("" + MainActivityPP.this.veloTins[5]);
                    }
                }, 50L);
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.64
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 102, -91});
                        }
                    }, 100L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.65
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                        }
            ...
            case R.id.left_right /* 2131362169 */:
                ...
                showUD();
                if (this.modeNum != 2) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.43
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                            MainActivityPP.this.velobar.setProgress(7.0f);
                ...
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.44
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    ...
                    if (this.modeCate == 0) {
                        ...
                        if (this.modeNum == 2 && this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.45
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (MainActivityPP.this.tagH == 1) {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 2, 0, 0, 0, 0, 0, 104, -91});
                                    }
                                    if (MainActivityPP.this.tagH == 2) {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 2, Ascii.SI, Ascii.NAK, 0, 0, 0, 114, -91});
                                    }
                                    if (MainActivityPP.this.tagH == 3) {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 2, Ascii.DLE, Ascii.DC4, 0, 0, 0, 110, -91});
                                    }
                                    if (MainActivityPP.this.tagH == 4) {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 2, 17, 19, 0, 0, 0, 106, -91});
                                    }
                                    if (MainActivityPP.this.tagH == 5) {
                                        MainActivityPP.this.writeBleData(new byte[]{-86, 106, 2, Ascii.SI, Ascii.DC2, Ascii.NAK, 0, 0, 96, -91});
                                    }
                                }
                            }, 30L);
                        }
            ...
            case R.id.place /* 2131362332 */:
                ...
                if (i6 != 8) {
                    ...
                    if (i6 == 1) {
                        ShowHelper.showProgressDialog(this, getResources().getString(R.string.change_point));
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.67
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                ShowHelper.dismissProgressDialog();
                            }
                        }, 1300L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.68
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                ShowHelper.dismissProgressDialog();
                            }
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.69
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        if (MainActivityPP.this.velobar.getProgress() > 2) {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[0], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[0] ^ 99), -91});
                            MainActivityPP.this.velobar.setProgress(1.0f);
                            MainActivityPP.this.v_tv.setText("" + MainActivityPP.this.veloTins[0]);
                        }
                    }
                }, 50L);
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.70
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivityPP.this.rotatebar.setProgress(0.0f);
                        MainActivityPP.this.r_tv.setText("0");
                        MainActivityPP.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 99, -91});
                    }
                }, 150L);
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.71
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    ...
                    if (this.modeCate == 0 && this.modeNum == 8) {
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.72
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivityPP.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                            }
            ...
            case R.id.selection /* 2131362414 */:
                ...
                this.modeCate = 1;
                changeOperate();
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.66
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                        MainActivityPP.this.velobar.setProgress(7.0f);
            ...
            case R.id.self_point /* 2131362423 */:
                ...
                if (this.modeNum != 1) {
                    this.isNumDing = 0;
                    ShowHelper.showProgressDialog(this, getResources().getString(R.string.change_point));
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.38
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            ShowHelper.dismissProgressDialog();
                        }
                    }, 1300L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.39
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            ShowHelper.dismissProgressDialog();
                        }
                ...
                this.modeCate = 0;
                changeOperate();
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.40
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                        MainActivityPP.this.velobar.setProgress(7.0f);
                ...
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.41
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 102, -91});
                        }
                    }, 100L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.42
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                        }
            ...
            case R.id.whole /* 2131362658 */:
                ...
                if (this.modeNum != 4) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.73
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 99, (byte) MainActivityPP.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivityPP.this.veloNums[6] ^ 99), -91});
                            MainActivityPP.this.velobar.setProgress(7.0f);
                ...
                this.start_layout.setGravity(1);
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.74
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
    ...
    class TimeCount1 extends CountDownTimer {
        ...
        public void onTick(long j) {
            if (20000 - j > 700) {
                MainActivityPP.access$1612(MainActivityPP.this, 50);
                if (MainActivityPP.this.ud < 50) {
                    MainActivityPP.this.ud = 50;
                }
                if (MainActivityPP.this.ud > 4250) {
                    MainActivityPP.this.ud = 4250;
                }
                short s = (short) MainActivityPP.this.lr;
                if (MainActivityPP.this.modeNum == 2) {
                    s = 0;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.TimeCount1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
    ...
    class TimeCount2 extends CountDownTimer {
        ...
        public void onTick(long j) {
            if (20000 - j > 700) {
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.TimeCount2.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
    ...
    class TimeCount3 extends CountDownTimer {
        ...
        public void onTick(long j) {
            if (20000 - j > 700) {
                MainActivityPP.access$1712(MainActivityPP.this, 50);
                if (MainActivityPP.this.lr < 50) {
                    MainActivityPP.this.lr = 50;
                }
                if (MainActivityPP.this.lr > 4250) {
                    MainActivityPP.this.lr = 4250;
                }
                short s = (short) MainActivityPP.this.lr;
                if (MainActivityPP.this.modeNum == 2) {
                    s = 0;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.TimeCount3.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
    ...
    class TimeCount4 extends CountDownTimer {
        ...
        public void onTick(long j) {
            if (20000 - j > 700) {
                MainActivityPP.access$1720(MainActivityPP.this, 50);
                if (MainActivityPP.this.lr < 50) {
                    MainActivityPP.this.lr = 50;
                }
                if (MainActivityPP.this.lr > 4250) {
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivityPP.TimeCount4.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivityPP.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
