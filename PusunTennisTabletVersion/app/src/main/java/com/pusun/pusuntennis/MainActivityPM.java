    ...
    public void connect(BleDevice bleDevice2) {
            ...
            if (mac != null) {
                BleManager.getInstance().connect(mac, new BleGattCallback() {
                    ...
                    public void onStartConnect() {
                        MainActivityPM mainActivity = MainActivityPM.this;
                    ...
                    public void onConnectSuccess(BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ...
                        if (resolvedName == null || resolvedName.isEmpty()) resolvedName = MainActivityPM.this.deviceName != null ? MainActivityPM.this.deviceName : "";
                        MainActivityPM.this.nameStar = resolvedName;
                        ...
                        if (bleDevice3.getMac() != null) MainActivityPM.this.deviceMac = bleDevice3.getMac();
                    ...
                    public void onDisConnected(boolean z, final BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ...
                        BleManager.getInstance().disconnectAllDevice();
                        MainActivityPM.this.isFaultOn = 0;
                        if (z || MainActivityPM.this.connNum >= 3) { return; }
                        new android.os.Handler().postDelayed(new Runnable() {
                            @Override public void run() { MainActivityPM.this.connect(bleDevice3); }
                        }, 1000L);
                    }
                });
            } else {
                android.util.Log.e("MainActivityPM", "connect: bleDevice and mac are both null, cannot connect");
            }
            return;
        }
        BleManager.getInstance().connect(bleDevice2, new BleGattCallback() { // from class: com.pusun.pusuntennis.MainActivityPM.33
            ...
            public void onConnectSuccess(BleDevice bleDevice3, BluetoothGatt bluetoothGatt, int i) {
                ...
                if (rawNameMainAc == null || rawNameMainAc.isEmpty()) rawNameMainAc = MainActivityPM.this.deviceName != null ? MainActivityPM.this.deviceName : "";
                MainActivityPM.this.nameStar = rawNameMainAc;
                MainActivityPM.this.blenoty.setText(MainActivityPM.this.getResources().getString(R.string.connected));
                MainActivityPM.this.blenoty.setBackground(MainActivityPM.this.getResources().getDrawable(R.drawable.button_selector));
                MainActivityPM.this.signal_note.setText(MainActivityPM.this.nameStar + MainActivityPM.this.getResources().getString(R.string.connected));
                MainActivityPM.this.signal_note.setTextColor(MainActivityPM.this.getResources().getColor(R.color.icon_green));
