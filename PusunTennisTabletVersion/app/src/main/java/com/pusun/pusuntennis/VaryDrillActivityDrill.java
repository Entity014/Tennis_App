...
import com.pusun.pusuntennis.adapter.VariSpinRv8001Adapter;
...
public class VaryDrillActivityDrill extends AppCompatActivity implements View.OnClickListener {
    ...
    private VariSpinRv8001Adapter variSpinRvAdapter;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_vary_drill_drill);
        ...
        for (int i = 0; i < BasicData37.b3.length; i++) {
            BasicData37.b3[i][3] = 40;
        }
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.root_layout), new OnApplyWindowInsetsListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill$$ExternalSyntheticLambda0
            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return VaryDrillActivityDrill.lambda$onCreate$0(view, windowInsetsCompat);
            }
        });
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                VaryDrillActivityDrill.this.finish();
            }
        });
        ...
        if (intExtra == 10) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.2
                @Override // java.lang.Runnable
                public synchronized void run() {
                    VaryDrillActivityDrill.this.showPoints();
                }
            }, 600L);
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.3
                @Override // java.lang.Runnable
                public synchronized void run() {
        ...
        if (intExtra == 6) {
            ...
            for (int i2 = 0; i2 < this.ballnum; i2++) {
                ...
                if (i2 == 0) {
                    if (this.lr == 0) {
                        ...
                        if (this.lh == 0) {
                            short[] sArr = BasicData37.b3[this.numleft[nextInt] - 1];
                            c4 = 3;
                        ...
                        if (this.lh == 2) {
                            short[] sArr2 = BasicData37.b3[this.numleft[nextInt] - 1];
                        ...
                        if (this.lh == 0) {
                            short[] sArr3 = BasicData37.b3[this.numright[nextInt2] - 1];
                            c3 = 3;
                        ...
                        if (this.lh == 2) {
                            short[] sArr4 = BasicData37.b3[this.numright[nextInt2] - 1];
                    ...
                    if (i2 == this.ballnum - 1 && i2 != 0) {
                        ...
                        if (this.lh == 0) {
                            short[] sArr5 = BasicData37.b3[this.nums1[nextInt3] - 1];
                            c2 = 3;
                        ...
                        if (this.lh == 2) {
                            short[] sArr6 = BasicData37.b3[this.nums1[nextInt3] - 1];
                        ...
                        if (this.lh == 0) {
                            short[] sArr7 = BasicData37.b3[this.nums1[nextInt4] - 1];
                            c = 3;
                        ...
                        if (this.lh == 2) {
                            short[] sArr8 = BasicData37.b3[this.nums1[nextInt4] - 1];
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.4
                @Override // java.lang.Runnable
                public synchronized void run() {
                    VaryDrillActivityDrill.this.showPoints();
                }
            }, 600L);
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.5
                @Override // java.lang.Runnable
                public synchronized void run() {
                    ShowHelper.dismissProgressDialog();
                }
        ...
        this.lastpoints2.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                new ArrayList();
                List loadAll = VaryDrillActivityDrill.this.daoSession.loadAll(WholeVary.class);
                if (loadAll != null && loadAll.size() != 0) {
                    String[] strArr = new String[loadAll.size()];
                    for (int size = loadAll.size() - 1; size >= 0; size--) {
                        strArr[(loadAll.size() - 1) - size] = ((WholeVary) loadAll.get(size)).getDaoName();
                    }
                    OptionPicker optionPicker = new OptionPicker(VaryDrillActivityDrill.this, strArr);
                    optionPicker.setOffset(2);
                    optionPicker.setSelectedIndex(0);
                    optionPicker.setTextSize(18);
                    optionPicker.setTitleText(VaryDrillActivityDrill.this.getResources().getString(R.string.select_route_name));
                    optionPicker.setCancelText(VaryDrillActivityDrill.this.getResources().getString(R.string.cancel));
                    optionPicker.setSubmitText(VaryDrillActivityDrill.this.getResources().getString(R.string.submit));
                    optionPicker.setOnOptionPickListener(new OptionPicker.OnOptionPickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.6.1
                        @Override // cn.qqtheme.framework.picker.OptionPicker.OnOptionPickListener
                        public void onOptionPicked(String str2) {
                            new ArrayList();
                            List loadAll2 = VaryDrillActivityDrill.this.daoSession.loadAll(WholeVary.class);
                            for (int i3 = 0; i3 < loadAll2.size(); i3++) {
                                if (((WholeVary) loadAll2.get(i3)).getDaoName().equals(str2)) {
                                    VaryDrillActivityDrill.this.select_dianwei.setText(((WholeVary) loadAll2.get(i3)).getSeles());
                                    String[] split = ((WholeVary) loadAll2.get(i3)).getSeles().split(",");
                                    VaryDrillActivityDrill.this.selectPoints.clear();
                                    for (String str3 : split) {
                                        VaryDrillActivityDrill.this.selectPoints.add(Integer.valueOf(Integer.parseInt(str3)));
                                    }
                                    VaryDrillActivityDrill.this.pa = ((WholeVary) loadAll2.get(i3)).getItem3();
                                    ...
                                    for (int i4 = 0; i4 < arrayList.size(); i4++) {
                                        if (arrayList.get(i4) != null && !"".equals(arrayList.get(i4))) {
                                            VaryDrillActivityDrill.this.setPara(((String) arrayList.get(i4)).split(","));
                                        }
                                    }
                                    VaryDrillActivityDrill.this.showPoints();
                                    return;
                ...
                VaryDrillActivityDrill varyDrillActivityDrill = VaryDrillActivityDrill.this;
                ShowHelper.toastShort(varyDrillActivityDrill, varyDrillActivityDrill.getResources().getString(R.string.no_route_name));
            }
        });
        this.savepoints2.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (VaryDrillActivityDrill.this.select_dianwei.getText() != null && !VaryDrillActivityDrill.this.select_dianwei.getText().toString().trim().isEmpty()) {
                    VaryDrillActivityDrill.this.alert_dialog_input2();
                } else {
                    VaryDrillActivityDrill varyDrillActivityDrill = VaryDrillActivityDrill.this;
                    ShowHelper.toastShort(varyDrillActivityDrill, varyDrillActivityDrill.getResources().getString(R.string.no_point_select));
                }
            }
        });
        this.delepoints2.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                new ArrayList();
                List loadAll = VaryDrillActivityDrill.this.daoSession.loadAll(WholeVary.class);
                if (loadAll != null && loadAll.size() != 0) {
                    ...
                    optionPicker.setCancelText(VaryDrillActivityDrill.this.getResources().getString(R.string.cancel));
                    optionPicker.setSubmitText(VaryDrillActivityDrill.this.getResources().getString(R.string.submit));
                    optionPicker.setOnOptionPickListener(new OptionPicker.OnOptionPickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.8.1
                        @Override // cn.qqtheme.framework.picker.OptionPicker.OnOptionPickListener
                        public void onOptionPicked(String str2) {
                            new ArrayList();
                            List loadAll2 = VaryDrillActivityDrill.this.daoSession.loadAll(WholeVary.class);
                            for (int i3 = 0; i3 < loadAll2.size(); i3++) {
                                if (((WholeVary) loadAll2.get(i3)).getDaoName().equals(str2)) {
                                    VaryDrillActivityDrill.this.daoSession.delete((WholeVary) loadAll2.get(i3));
                                    ShowHelper.toastShort(VaryDrillActivityDrill.this, VaryDrillActivityDrill.this.getResources().getString(R.string.already_dele));
                                    return;
                                }
                            }
                        }
    ...
    public void setPara(String[] strArr) {
        BasicData37.b3[Integer.parseInt(strArr[5]) - 1][0] = Short.parseShort(strArr[0]);
        BasicData37.b3[Integer.parseInt(strArr[5]) - 1][1] = Short.parseShort(strArr[1]);
        BasicData37.b3[Integer.parseInt(strArr[5]) - 1][2] = Short.parseShort(strArr[2]);
        BasicData37.b3[Integer.parseInt(strArr[5]) - 1][3] = Short.parseShort(strArr[3]);
        BasicData37.b3[Integer.parseInt(strArr[5]) - 1][4] = Short.parseShort(strArr[4]);
    }
    ...
    public void alert_dialog_input2() {
        ...
        ((Button) inflate.findViewById(R.id.negative)).setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                create.dismiss();
            }
        });
        ((Button) inflate.findViewById(R.id.positive)).setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.VaryDrillActivityDrill.10
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (editText.getText().toString() != null && !editText.getText().toString().trim().equals("")) {
                    int size = VaryDrillActivityDrill.this.selectPoints.size();
                    new ArrayList();
                    VaryDrillActivityDrill.this.daoSession.loadAll(WholeVary.class);
                    WholeVary wholeVary = new WholeVary();
                    wholeVary.setDaoName("" + editText.getText().toString().trim());
                    wholeVary.setSeles(VaryDrillActivityDrill.this.select_dianwei.getText().toString().trim());
                    wholeVary.setItem3(VaryDrillActivityDrill.this.pa);
                    if (size >= 1) {
                        wholeVary.setPara1(VaryDrillActivityDrill.this.setString(0));
                    }
                    if (size >= 2) {
                        wholeVary.setPara2(VaryDrillActivityDrill.this.setString(1));
                    }
                    if (size >= 3) {
                        wholeVary.setPara3(VaryDrillActivityDrill.this.setString(2));
                    }
                    if (size >= 4) {
                        wholeVary.setPara4(VaryDrillActivityDrill.this.setString(3));
                    }
                    if (size >= 5) {
                        wholeVary.setPara5(VaryDrillActivityDrill.this.setString(4));
                    }
                    if (size >= 6) {
                        wholeVary.setPara6(VaryDrillActivityDrill.this.setString(5));
                    }
                    if (size >= 7) {
                        wholeVary.setPara7(VaryDrillActivityDrill.this.setString(6));
                    }
                    if (size >= 8) {
                        wholeVary.setPara8(VaryDrillActivityDrill.this.setString(7));
                    }
                    if (size >= 9) {
                        wholeVary.setPara9(VaryDrillActivityDrill.this.setString(8));
                    }
                    if (size >= 10) {
                        wholeVary.setPara10(VaryDrillActivityDrill.this.setString(9));
                    }
                    if (size >= 11) {
                        wholeVary.setPara11(VaryDrillActivityDrill.this.setString(10));
                    }
                    if (size >= 12) {
                        wholeVary.setPara12(VaryDrillActivityDrill.this.setString(11));
                    }
                    if (size >= 13) {
                        wholeVary.setPara13(VaryDrillActivityDrill.this.setString(12));
                    }
                    if (size >= 14) {
                        wholeVary.setPara14(VaryDrillActivityDrill.this.setString(13));
                    }
                    if (size >= 15) {
                        wholeVary.setPara15(VaryDrillActivityDrill.this.setString(14));
                    }
                    VaryDrillActivityDrill.this.daoSession.insertOrReplace(wholeVary);
                    create.dismiss();
                    return;
                }
                VaryDrillActivityDrill varyDrillActivityDrill = VaryDrillActivityDrill.this;
                ShowHelper.toastShort(varyDrillActivityDrill, varyDrillActivityDrill.getResources().getString(R.string.input_route_name));
            }
        });
        create.show();
    }
    ...
    public String setString(int i) {
        return ((int) BasicData37.b3[this.selectPoints.get(i).intValue() - 1][0]) + "," + ((int) BasicData37.b3[this.selectPoints.get(i).intValue() - 1][1]) + "," + ((int) BasicData37.b3[this.selectPoints.get(i).intValue() - 1][2]) + "," + ((int) BasicData37.b3[this.selectPoints.get(i).intValue() - 1][3]) + "," + ((int) BasicData37.b3[this.selectPoints.get(i).intValue() - 1][4]) + "," + ((int) BasicData37.b3[this.selectPoints.get(i).intValue() - 1][5]);
    }
    ...
    public void showPoints() {
        if (this.selectPoints.size() != 0) {
            ...
            for (int i2 = 0; i2 < this.selectPoints.size(); i2++) {
                ...
                while (true) {
                    ...
                    if (this.selectPoints.get(i2).intValue() == this.poids[i3] + 1) {
                        this.pos[i3].setBackground(getResources().getDrawable(R.drawable.pickle));
                        break;
                    }
                    i3++;
                }
            ...
            this.variSpinRvAdapter = new VariSpinRv8001Adapter(this.selectPoints, this);
