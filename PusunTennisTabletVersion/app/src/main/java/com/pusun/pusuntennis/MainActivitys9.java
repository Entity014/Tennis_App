...
public class MainActivitys9 extends AppCompatActivity implements View.OnClickListener {
    ...
    public void showSelectPoint(int i) {
        ...
        sb2.append(BasicData26.b3[i2][2]);
    ...
    public void connect(BleDevice bleDevice2) {
            ...
            if (mac != null) {
                BleManager.getInstance().connect(mac, new BleGattCallback() {
                    ...
                    public void onStartConnect() {
                        MainActivitys9 mainActivity = MainActivitys9.this;
                    ...
                    public void onConnectSuccess(BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ...
                        if (resolvedName == null || resolvedName.isEmpty()) resolvedName = MainActivitys9.this.deviceName != null ? MainActivitys9.this.deviceName : "";
                        MainActivitys9.this.nameStar = resolvedName;
                        ...
                        if (bleDevice3.getMac() != null) MainActivitys9.this.deviceMac = bleDevice3.getMac();
                    ...
                    public void onDisConnected(boolean z, final BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ...
                        BleManager.getInstance().disconnectAllDevice();
                        MainActivitys9.this.isFaultOn = 0;
                        if (z || MainActivitys9.this.connNum >= 3) { return; }
                        new android.os.Handler().postDelayed(new Runnable() {
                            @Override public void run() { MainActivitys9.this.connect(bleDevice3); }
                        }, 1000L);
                    }
                });
            } else {
                android.util.Log.e("MainActivitys9", "connect: bleDevice and mac are both null, cannot connect");
            }
            return;
        }
        BleManager.getInstance().connect(bleDevice2, new BleGattCallback() { // from class: com.pusun.pusuntennis.MainActivitys9.53
            ...
            public void onConnectSuccess(BleDevice bleDevice3, BluetoothGatt bluetoothGatt, int i) {
                ...
                if (rawNameMainAc == null || rawNameMainAc.isEmpty()) rawNameMainAc = MainActivitys9.this.deviceName != null ? MainActivitys9.this.deviceName : "";
                MainActivitys9.this.nameStar = rawNameMainAc;
                MainActivitys9.this.blenoty.setText(MainActivitys9.this.getResources().getString(R.string.connected));
                MainActivitys9.this.blenoty.setBackground(MainActivitys9.this.getResources().getDrawable(R.drawable.button_selector));
                MainActivitys9.this.signal_note.setText(MainActivitys9.this.nameStar + MainActivitys9.this.getResources().getString(R.string.connected));
                MainActivitys9.this.signal_note.setTextColor(MainActivitys9.this.getResources().getColor(R.color.icon_green));
