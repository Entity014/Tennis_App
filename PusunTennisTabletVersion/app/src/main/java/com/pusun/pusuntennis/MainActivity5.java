        ...
        this.u_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivity5.3
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (action == 0) {
                    ...
                    if (MainActivity5.this.ud > 4500) {
                        MainActivity5.this.ud = 4500;
                    }
                    if (MainActivity5.this.modeCate == 0 && ((MainActivity5.this.modeNum == 1 || MainActivity5.this.modeNum == 2) && MainActivity5.this.ud > 4500)) {
                        MainActivity5.this.ud = 4500;
                    }
        ...
        indicatorSeekBar3.setOnSeekChangeListener(new OnSeekChangeListener() { // from class: com.pusun.pusuntennis.MainActivity5.11
            ...
            public void onStopTrackingTouch(IndicatorSeekBar indicatorSeekBar4) {
                ...
                if (progress < 5 && MainActivity5.this.rotatebar.getProgress() != 0) {
                    MainActivity5.this.r_tv.setText("0");
        ...
        this.blenoty.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity5.17
            ...
            public void onClick(View view) {
                if (MainActivity5.this.blenoty.getText().toString().trim().contains(MainActivity5.this.getResources().getString(R.string.disconnected))) {
                    ...
                    if (MainActivity5.bleDevice != null) {
                        MainActivity5.this.connect(MainActivity5.bleDevice);
                    } else {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity5.24
                ...
                public synchronized void run() {
                    ...
                    while (i5 < BasicData3.b3.length) {
                        int i6 = i5 + 1;
                        byte b2 = (byte) i6;
                        final byte[] bArr2 = {-86, b2, (byte) (BasicData3.b3[i5][0] >> 8), (byte) BasicData3.b3[i5][0], (byte) ((BasicData3.b3[i5][1] - final_i2) >> 8), (byte) (BasicData3.b3[i5][1] - final_i2), 0, 0, (byte) ((((((byte) (BasicData3.b3[i5][0] >> 8)) ^ b2) ^ ((byte) BasicData3.b3[i5][0])) ^ ((byte) ((BasicData3.b3[i5][1] - final_i2) >> 8))) ^ ((byte) (BasicData3.b3[i5][1] - final_i2))), -91};
                        AppLog.e("左右：" + ((int) BasicData3.b3[i5][0]) + "上下：" + (BasicData3.b3[i5][1] - final_i2) + "byte:" + MainActivity5.bytesToHexString(bArr2));
    ...
    public void connect(BleDevice bleDevice2) {
            ...
            if (mac != null) {
                BleManager.getInstance().connect(mac, new BleGattCallback() {
                    ...
                    public void onStartConnect() {
                        MainActivity5 mainActivity = MainActivity5.this;
                    ...
                    public void onConnectSuccess(BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ...
                        if (resolvedName == null || resolvedName.isEmpty()) resolvedName = MainActivity5.this.deviceName != null ? MainActivity5.this.deviceName : "";
                        MainActivity5.this.nameStar = resolvedName;
                        ...
                        if (bleDevice3.getMac() != null) MainActivity5.this.deviceMac = bleDevice3.getMac();
                    ...
                    public void onDisConnected(boolean z, final BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ...
                        BleManager.getInstance().disconnectAllDevice();
                        MainActivity5.this.isFaultOn = 0;
                        if (z || MainActivity5.this.connNum >= 3) { return; }
                        new android.os.Handler().postDelayed(new Runnable() {
                            @Override public void run() { MainActivity5.this.connect(bleDevice3); }
                        }, 1000L);
                    }
                });
            } else {
                android.util.Log.e("MainActivity5", "connect: bleDevice and mac are both null, cannot connect");
            }
            return;
        }
        BleManager.getInstance().connect(bleDevice2, new BleGattCallback() { // from class: com.pusun.pusuntennis.MainActivity5.30
            ...
            public void onConnectSuccess(BleDevice bleDevice3, BluetoothGatt bluetoothGatt, int i) {
                ...
                if (rawNameMainAc == null || rawNameMainAc.isEmpty()) rawNameMainAc = MainActivity5.this.deviceName != null ? MainActivity5.this.deviceName : "";
                MainActivity5.this.nameStar = rawNameMainAc;
                MainActivity5.this.blenoty.setText(MainActivity5.this.getResources().getString(R.string.connected));
                MainActivity5.this.blenoty.setBackground(MainActivity5.this.getResources().getDrawable(R.drawable.button_selector));
                MainActivity5.this.signal_note.setText(MainActivity5.this.nameStar + MainActivity5.this.getResources().getString(R.string.connected));
                MainActivity5.this.signal_note.setTextColor(MainActivity5.this.getResources().getColor(R.color.icon_green));
