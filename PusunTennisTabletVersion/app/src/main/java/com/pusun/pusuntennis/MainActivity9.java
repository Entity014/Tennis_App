...
public class MainActivity9 extends AppCompatActivity implements View.OnClickListener {
    ...
    static /* synthetic */ int access$1612(MainActivity9 mainActivity9, int i) {
        int i2 = mainActivity9.ud + i;
        mainActivity9.ud = i2;
        return i2;
    }

    static /* synthetic */ int access$1620(MainActivity9 mainActivity9, int i) {
        int i2 = mainActivity9.ud - i;
        mainActivity9.ud = i2;
        return i2;
    }

    static /* synthetic */ int access$1712(MainActivity9 mainActivity9, int i) {
        int i2 = mainActivity9.lr + i;
        mainActivity9.lr = i2;
        return i2;
    }

    static /* synthetic */ int access$1720(MainActivity9 mainActivity9, int i) {
        int i2 = mainActivity9.lr - i;
        mainActivity9.lr = i2;
        return i2;
    }

    static /* synthetic */ int access$5708(MainActivity9 mainActivity9) {
        int i = mainActivity9.connNum;
        mainActivity9.connNum = i + 1;
        return i;
    }

    static /* synthetic */ int access$6308(MainActivity9 mainActivity9) {
        int i = mainActivity9.isFaultOn;
        mainActivity9.isFaultOn = i + 1;
        return i;
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.root_layout), new OnApplyWindowInsetsListener() { // from class: com.pusun.pusuntennis.MainActivity9$$ExternalSyntheticLambda0
            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return MainActivity9.lambda$onCreate$0(view, windowInsetsCompat);
            }
        });
        ...
        this.adju.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                MainActivity9.this.showAdjust();
            }
        });
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.2
            @Override // java.lang.Runnable
            public synchronized void run() {
                MainActivity9.this.getUrlTxt();
            }
        }, 1000L);
        ...
        this.spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.pusun.pusuntennis.MainActivity9.3
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long j) {
                if (i == 1) {
                    ...
                    mainActivity9.showPos(mainActivity9.gr1);
                    return;
                }
                if (i == 2) {
                    MainActivity9 mainActivity92 = MainActivity9.this;
                    mainActivity92.showPos(mainActivity92.gr2);
                    return;
                }
                if (i == 3) {
                    MainActivity9 mainActivity93 = MainActivity9.this;
                    mainActivity93.showPos(mainActivity93.gr3);
                    return;
                }
                if (i == 4) {
                    MainActivity9 mainActivity94 = MainActivity9.this;
                    mainActivity94.showPos(mainActivity94.gr4);
                    return;
                }
                if (i == 5) {
                    MainActivity9 mainActivity95 = MainActivity9.this;
                    mainActivity95.showPos(mainActivity95.gr5);
                    return;
                }
                if (i == 6) {
                    MainActivity9 mainActivity96 = MainActivity9.this;
                    mainActivity96.showPos(mainActivity96.gr6);
                    return;
                }
                if (i == 7) {
                    MainActivity9 mainActivity97 = MainActivity9.this;
                    mainActivity97.showPos(mainActivity97.gr7);
                    return;
                }
                if (i == 8) {
                    MainActivity9 mainActivity98 = MainActivity9.this;
                    mainActivity98.showPos(mainActivity98.gr8);
                    return;
                }
                if (i == 9) {
                    MainActivity9 mainActivity99 = MainActivity9.this;
                    mainActivity99.showPos(mainActivity99.gr9);
                    return;
                }
                if (i == 10) {
                    MainActivity9 mainActivity910 = MainActivity9.this;
                    mainActivity910.showPos(mainActivity910.gr10);
                } else if (i == 11) {
                    MainActivity9 mainActivity911 = MainActivity9.this;
                    mainActivity911.showPos(mainActivity911.gr11);
                } else if (i == 12) {
                    MainActivity9 mainActivity912 = MainActivity9.this;
                    mainActivity912.showPos(mainActivity912.gr12);
                } else {
                    MainActivity9 mainActivity913 = MainActivity9.this;
                    mainActivity913.showPos(mainActivity913.poids);
                }
            }
        });
        ...
        this.d_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivity9.4
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (action == 0) {
                    ...
                    AppLog.e("up:1");
                    if (MainActivity9.this.ud >= 1410) {
                        MainActivity9.access$1612(MainActivity9.this, 30);
                    }
                    if (MainActivity9.this.ud < 1410) {
                        MainActivity9.access$1612(MainActivity9.this, 50);
                    }
                    if (MainActivity9.this.ud < 1110) {
                        MainActivity9.this.ud = 1110;
                    }
                    if (MainActivity9.this.ud > 1830) {
                        MainActivity9.this.ud = 1830;
                    }
                    short s = (short) MainActivity9.this.lr;
                    if (MainActivity9.this.modeNum == 2) {
                        s = 0;
                    }
                    short s2 = (short) MainActivity9.this.ud;
                    if (MainActivity9.this.modeNum == 3) {
                        s2 = 0;
                    }
                    MainActivity9.this.writeBleData(new byte[]{-86, 108, (byte) (s >> 8), (byte) s, (byte) (s2 >> 8), (byte) s2, 0, 0, 1, -91});
                    MainActivity9.this.num_lr.setText("" + (70 - (MainActivity9.this.lr / 30)));
                    if (MainActivity9.this.ud > 1410) {
                        MainActivity9.this.num_ud.setText("" + (64 - (MainActivity9.this.ud / 30)));
                    } else {
                        MainActivity9.this.num_ud.setText("" + (((1410 - MainActivity9.this.ud) / 50) + 17));
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.4.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.4.2
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                        }
                    }, 1L);
                    ...
                    AppLog.e("touch up1");
                    MainActivity9.this.isTouch = false;
                    if (MainActivity9.this.timeCount1 != null) {
                        MainActivity9.this.timeCount1.cancel();
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.4.3
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            if (MainActivity9.this.timeCount1 != null) {
                                MainActivity9.this.timeCount1.cancel();
        ...
        this.u_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivity9.5
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action == 0) {
                    ...
                    AppLog.e("down:1");
                    if (MainActivity9.this.ud <= 1410) {
                        MainActivity9.access$1620(MainActivity9.this, 50);
                    }
                    if (MainActivity9.this.ud > 1410) {
                        MainActivity9.access$1620(MainActivity9.this, 30);
                    }
                    if (MainActivity9.this.ud < 1110) {
                        MainActivity9.this.ud = 1110;
                    }
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.5.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.5.2
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                        }
                    }, 1L);
                    ...
                    MainActivity9.this.isTouch = false;
                    if (MainActivity9.this.timeCount2 != null) {
                        MainActivity9.this.timeCount2.cancel();
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.5.3
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            if (MainActivity9.this.timeCount2 != null) {
                                MainActivity9.this.timeCount2.cancel();
        ...
        this.l_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivity9.6
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action == 0) {
                    ...
                    AppLog.e("left:1");
                    MainActivity9.access$1712(MainActivity9.this, 30);
                    if (MainActivity9.this.lr < 1140) {
                        MainActivity9.this.lr = 1140;
                    }
                    if (MainActivity9.this.lr > 2040) {
                        MainActivity9.this.lr = 2040;
                    }
                    short s = (short) MainActivity9.this.lr;
                    if (MainActivity9.this.modeNum == 2) {
                        s = 0;
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.6.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.6.2
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                        }
                    }, 1L);
                    ...
                    MainActivity9.this.isTouch = false;
                    if (MainActivity9.this.timeCount3 != null) {
                        MainActivity9.this.timeCount3.cancel();
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.6.3
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            if (MainActivity9.this.timeCount3 != null) {
                                MainActivity9.this.timeCount3.cancel();
        ...
        this.ri_ad.setOnTouchListener(new View.OnTouchListener() { // from class: com.pusun.pusuntennis.MainActivity9.7
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action == 0) {
                    ...
                    AppLog.e("right:1");
                    MainActivity9.access$1720(MainActivity9.this, 30);
                    if (MainActivity9.this.lr < 1140) {
                        MainActivity9.this.lr = 1140;
                    }
                    if (MainActivity9.this.lr > 2040) {
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.7.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.7.2
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                        }
                    }, 1L);
                    ...
                    MainActivity9.this.isTouch = false;
                    if (MainActivity9.this.timeCount4 != null) {
                        MainActivity9.this.timeCount4.cancel();
                    }
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.7.3
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            if (MainActivity9.this.timeCount4 != null) {
                                MainActivity9.this.timeCount4.cancel();
        ...
        this.change_point.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                MainActivity9.this.writeBleData(new byte[]{-86, 112, 3, Ascii.SYN, 5, Ascii.FF, 1, 0, 1, -91});
            }
        });
        this.change_get.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                MainActivity9.this.writeBleData(new byte[]{-86, 113, 0, 0, 0, 0, 0, 0, 1, -91});
            }
        });
        IndicatorSeekBar indicatorSeekBar = (IndicatorSeekBar) findViewById(R.id.freq);
        this.freq = indicatorSeekBar;
        indicatorSeekBar.setOnSeekChangeListener(new OnSeekChangeListener() { // from class: com.pusun.pusuntennis.MainActivity9.10
            ...
            public void onStopTrackingTouch(IndicatorSeekBar indicatorSeekBar2) {
                ...
                MainActivity9.this.f_tv.setText("" + progress);
                if (MainActivity9.this.btn_ball.getText().toString().equals(MainActivity9.this.getResources().getString(R.string.stop))) {
                    int i = progress - 1;
                    MainActivity9.this.writeBleData(new byte[]{-86, 97, (byte) MainActivity9.this.frequentNums[i], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.frequentNums[i] ^ 97), -91});
                }
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.10.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
        ...
        this.freqde.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.11
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                int intValue = Integer.valueOf(MainActivity9.this.f_tv.getText().toString().trim()).intValue();
                if (intValue > 1) {
                    int i = intValue - 1;
                    MainActivity9.this.f_tv.setText("" + i);
                    MainActivity9.this.freq.setProgress((float) i);
                    int i2 = intValue + (-2);
                    MainActivity9.this.writeBleData(new byte[]{-86, 97, (byte) MainActivity9.this.frequentNums[i2], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.frequentNums[i2] ^ 97), -91});
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.11.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
        ...
        this.freqadd.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.12
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                int intValue = Integer.valueOf(MainActivity9.this.f_tv.getText().toString().trim()).intValue();
                if (intValue < 10) {
                    ...
                    MainActivity9.this.f_tv.setText("" + i);
                    MainActivity9.this.freq.setProgress((float) i);
                    MainActivity9.this.writeBleData(new byte[]{-86, 97, (byte) MainActivity9.this.frequentNums[intValue], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.frequentNums[intValue] ^ 97), -91});
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.12.1
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
        ...
        indicatorSeekBar2.setOnSeekChangeListener(new OnSeekChangeListener() { // from class: com.pusun.pusuntennis.MainActivity9.13
            @Override // com.warkiz.widget.OnSeekChangeListener
            public void onSeeking(SeekParams seekParams) {
            }
            ...
            public void onStopTrackingTouch(IndicatorSeekBar indicatorSeekBar3) {
                ...
                if (MainActivity9.this.modeCate == 0 && MainActivity9.this.modeNum == 8) {
                ...
                if (progress != 0 && MainActivity9.this.velobar.getProgress() < 5) {
                    MainActivity9.this.velobar.setProgress(5.0f);
                    MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[4], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[4] ^ 99), -91});
                    MainActivity9.this.v_tv.setText("" + MainActivity9.this.veloTins[4]);
                }
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.13.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
                ...
                if (progress < 0) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.13.2
                        @Override // java.lang.Runnable
                        public void run() {
                            int i = progress;
                            MainActivity9.this.writeBleData(new byte[]{-86, 98, 2, (byte) ((-i) * 5), 0, 0, 0, 0, (byte) (((-i) * 5) ^ 96), -91});
                        }
                    }, 100L);
                }
                if (progress > 0) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.13.3
                        @Override // java.lang.Runnable
                        public void run() {
                            int i = progress;
                            MainActivity9.this.writeBleData(new byte[]{-86, 98, 1, (byte) (i * 5), 0, 0, 0, 0, (byte) ((i * 5) ^ 99), -91});
                        }
                    }, 100L);
                }
                if (progress == 0) {
                    MainActivity9.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 98, -91});
                }
                MainActivity9.this.r_tv.setText("" + progress);
            }
        });
        IndicatorSeekBar indicatorSeekBar3 = (IndicatorSeekBar) findViewById(R.id.velobar);
        this.velobar = indicatorSeekBar3;
        indicatorSeekBar3.setOnSeekChangeListener(new OnSeekChangeListener() { // from class: com.pusun.pusuntennis.MainActivity9.14
            @Override // com.warkiz.widget.OnSeekChangeListener
            public void onSeeking(SeekParams seekParams) {
            }
            ...
            public void onStopTrackingTouch(IndicatorSeekBar indicatorSeekBar4) {
                if (MainActivity9.this.forbid == 1) {
                    MainActivity9 mainActivity9 = MainActivity9.this;
                    ShowHelper.showAlertDialog(mainActivity9, mainActivity9.getResources().getString(R.string.alert), MainActivity9.this.getResources().getString(R.string.forbid_alert));
                    return;
                }
                int progress = indicatorSeekBar4.getProgress();
                if (MainActivity9.this.modeCate == 0 && MainActivity9.this.modeNum == 5 && progress > 6) {
                    indicatorSeekBar4.setProgress(6.0f);
                    progress = 6;
                }
                TextView textView12 = MainActivity9.this.v_tv;
                StringBuilder sb = new StringBuilder("");
                int i = progress - 1;
                sb.append(MainActivity9.this.veloTins[i]);
                textView12.setText(sb.toString());
                if (progress < 5 && MainActivity9.this.rotatebar.getProgress() != 0) {
                    MainActivity9.this.r_tv.setText("0");
                    MainActivity9.this.rotatebar.setProgress(0.0f);
                    MainActivity9.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 98, -91});
                }
                MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[i], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[i] ^ 99), -91});
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.14.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
        ...
        this.spde.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.15
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (MainActivity9.this.forbid != 1) {
                    int progress = MainActivity9.this.velobar.getProgress();
                    if (progress > 1) {
                        int i = progress - 1;
                        TextView textView12 = MainActivity9.this.v_tv;
                        StringBuilder sb = new StringBuilder("");
                        int i2 = progress - 2;
                        sb.append(MainActivity9.this.veloTins[i2]);
                        textView12.setText(sb.toString());
                        MainActivity9.this.velobar.setProgress(i);
                        if (i < 4 && MainActivity9.this.rotatebar.getProgress() != 0) {
                            MainActivity9.this.r_tv.setText("0");
                            MainActivity9.this.rotatebar.setProgress(0.0f);
                            MainActivity9.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 98, -91});
                        }
                        MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[i2], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[i2] ^ 99), -91});
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.15.1
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                            }
        ...
        this.spadd.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.16
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (MainActivity9.this.forbid != 1) {
                    int progress = MainActivity9.this.velobar.getProgress();
                    if (progress < 13) {
                        int i = progress + 1;
                        MainActivity9.this.v_tv.setText("" + MainActivity9.this.veloTins[progress]);
                        MainActivity9.this.velobar.setProgress((float) i);
                        if (i < 4 && MainActivity9.this.rotatebar.getProgress() != 0) {
                            MainActivity9.this.r_tv.setText("0");
                            MainActivity9.this.rotatebar.setProgress(0.0f);
                            MainActivity9.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 98, -91});
                        }
                        MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[progress], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[progress] ^ 99), -91});
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.16.1
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                            }
        ...
        this.switchbtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.pusun.pusuntennis.MainActivity9.17
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
                    MainActivity9.this.self.setVisibility(8);
                    MainActivity9.this.group.setVisibility(0);
                    MainActivity9.this.points.setVisibility(0);
                    MainActivity9.this.hintpoints.setVisibility(0);
                    MainActivity9.this.group_cate.setVisibility(0);
                    MainActivity9.this.tennipic2.setVisibility(8);
                    MainActivity9.this.tennipic3.setVisibility(8);
                    MainActivity9.this.tennipic4.setVisibility(8);
                    MainActivity9.this.tennipic5.setVisibility(8);
                    MainActivity9.this.fourbtn.setVisibility(8);
                    MainActivity9.this.bg_four.setVisibility(8);
                    MainActivity9.this.bg_input.setVisibility(0);
                    RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) MainActivity9.this.start_layout.getLayoutParams();
                    layoutParams.height = (int) (MainActivity9.this.density * 36.0f);
                    MainActivity9.this.start_layout.setLayoutParams(layoutParams);
                    MainActivity9.this.start_layout.setGravity(17);
                    MainActivity9.this.modeCate = 1;
                    return;
                }
                MainActivity9.this.self.setVisibility(0);
                MainActivity9.this.group.setVisibility(8);
                MainActivity9.this.points.setVisibility(8);
                MainActivity9.this.hintpoints.setVisibility(8);
                MainActivity9.this.tennipic2.setVisibility(0);
                MainActivity9.this.bg_input.setVisibility(8);
                MainActivity9.this.group_cate.setVisibility(8);
                RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) MainActivity9.this.start_layout.getLayoutParams();
                layoutParams2.height = (int) (MainActivity9.this.density * 90.0f);
                MainActivity9.this.start_layout.setLayoutParams(layoutParams2);
                MainActivity9.this.start_layout.setGravity(83);
                MainActivity9.this.fourbtn.setVisibility(0);
                MainActivity9.this.bg_four.setVisibility(0);
                if (MainActivity9.this.modeNum == 2) {
                    MainActivity9.this.tennipic3.setVisibility(0);
                    MainActivity9.this.tennipic4.setVisibility(8);
                    MainActivity9.this.tennipic5.setVisibility(8);
                }
                if (MainActivity9.this.modeNum == 3) {
                    MainActivity9.this.tennipic3.setVisibility(8);
                    MainActivity9.this.tennipic4.setVisibility(0);
                    MainActivity9.this.tennipic5.setVisibility(8);
                }
                if (MainActivity9.this.modeNum == 4) {
                    MainActivity9.this.tennipic3.setVisibility(8);
                    MainActivity9.this.tennipic4.setVisibility(8);
                    MainActivity9.this.tennipic5.setVisibility(0);
                }
                MainActivity9.this.modeCate = 0;
            }
        });
        this.blenoty.setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.18
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (MainActivity9.this.blenoty.getText().toString().trim().contains(MainActivity9.this.getResources().getString(R.string.disconnected))) {
                    ...
                    MainActivity9.this.blenoty.setBackground(MainActivity9.this.getResources().getDrawable(R.drawable.button_stop_selector));
                }
            }
        });
        this.rgheight.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.pusun.pusuntennis.MainActivity9.19
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    case R.id.radio0 /* 2131362353 */:
                        MainActivity9.this.radioNum = 0;
                        MainActivity9.this.sendBaseData(0);
                        break;
                    case R.id.radio1 /* 2131362354 */:
                        MainActivity9.this.radioNum = 1;
                        MainActivity9.this.sendBaseData(1);
                        break;
                    case R.id.radio2 /* 2131362355 */:
                        MainActivity9.this.radioNum = 2;
                        MainActivity9.this.sendBaseData(2);
                        break;
                }
            }
        });
    ...
    public void showAdjust() {
        ...
        dialog.show();
        dialog.findViewById(R.id.conf).setOnClickListener(new View.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.20
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                dialog.dismiss();
            }
    ...
    public void getUrlTxt() {
        new Thread(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.21
            @Override // java.lang.Runnable
            public void run() {
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            Looper.prepare();
                            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.21.1
                                @Override // java.lang.Runnable
                                public synchronized void run() {
                                    ...
                                    while (true) {
                                        if (i < split.length) {
                                            if (com.pusun.pusuntennis.utils.Util.getDeviceName(MainActivity9.bleDevice).equals(split[i].toString().trim())) {
                                                ...
                                                edit.commit();
                                                SharedPreferences sharedPreferences = MainActivity9.this.getSharedPreferences(MainActivity9.FORBID_INFO, 0);
                                                AppLog.e("" + sharedPreferences.getInt(MainActivity9.FORBID_INFO, 0));
                                                MainActivity9.this.forbid = sharedPreferences.getInt(MainActivity9.FORBID_INFO, 0);
                                                break;
                                            }
                                            i++;
                                        } else {
                                            SharedPreferences.Editor edit2 = MainActivity9.this.getSharedPreferences(MainActivity9.FORBID_INFO, 0).edit();
                                            edit2.putInt(MainActivity9.FORBID_INFO, 0);
                                            edit2.commit();
                                            SharedPreferences sharedPreferences2 = MainActivity9.this.getSharedPreferences(MainActivity9.FORBID_INFO, 0);
                                            AppLog.e("" + sharedPreferences2.getInt(MainActivity9.FORBID_INFO, 0));
                                            MainActivity9.this.forbid = sharedPreferences2.getInt(MainActivity9.FORBID_INFO, 0);
                                            break;
                                        }
                                    }
                                }
    ...
    private void sendBaseData() {
        ...
        while (i < BasicData2.b2.length) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.22
                @Override // java.lang.Runnable
                public synchronized void run() {
                    AppLog.e("第" + final_i + "条指令");
                    MainActivity9.this.writeBleData(bArr);
                }
            }, (long) (i * 10));
            i = i2;
        }
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.23
            @Override // java.lang.Runnable
            public synchronized void run() {
                int i3 = 10;
        while (i3 < BasicData2.b2.length) {
            final int final_i3 = i3;
                    ...
                    AppLog.e("左右：" + ((int) BasicData2.b2[i3][0]) + "上下：" + ((int) BasicData2.b2[i3][1]) + "byte:" + MainActivity9.bytesToHexString(bArr2));
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.23.1
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            AppLog.e("第" + final_i3 + "条指令");
                            MainActivity9.this.writeBleData(bArr2);
                        }
                    }, (long) (i3 * 10));
                    i3 = i4;
                }
    ...
    public void sendBaseData(int i) {
        ...
        while (i2 < BasicData2.b3.length) {
            final int final_i2 = i2;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.24
                    @Override // java.lang.Runnable
                    public synchronized void run() {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.25
                @Override // java.lang.Runnable
                public synchronized void run() {
                    int i4 = 10;
        while (i4 < BasicData2.b3.length) {
            final int final_i4 = i4;
                        ...
                        AppLog.e("左右：" + ((int) BasicData2.b3[i4][0]) + "上下：" + ((int) BasicData2.b3[i4][1]) + "byte:" + MainActivity9.bytesToHexString(bArr2));
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.25.1
                            @Override // java.lang.Runnable
                            public synchronized void run() {
        ...
        while (i4 < BasicData2.b4.length) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.26
                @Override // java.lang.Runnable
                public synchronized void run() {
                    AppLog.e("第" + final_i4 + "条指令");
                    MainActivity9.this.writeBleData(bArr2);
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.27
            @Override // java.lang.Runnable
            public synchronized void run() {
                int i6 = 10;
        while (i6 < BasicData2.b4.length) {
            final int final_i6 = i6;
                    ...
                    AppLog.e("左右：" + ((int) BasicData2.b4[i6][0]) + "上下：" + ((int) BasicData2.b4[i6][1]) + "byte:" + MainActivity9.bytesToHexString(bArr3));
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.27.1
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            AppLog.e("第" + final_i6 + "条指令");
                            MainActivity9.this.writeBleData(bArr3);
                        }
                    }, (long) (i6 * 10));
                    i6 = i7;
                }
    ...
    public void writeBleData(byte[] bArr) {
        ...
        if (str != null && (str.startsWith("PT0") || this.nameStar.startsWith("PT1"))) {
            BleManager.getInstance().write(bleDevice, BLEServiceParameters.BLE_WRITE_SERVICE_UUIDA, BLEServiceParameters.BLE_WRITE_SERVICE_CHARACTER_UUIDA, bArr, new BleWriteCallback() { // from class: com.pusun.pusuntennis.MainActivity9.28
                ...
                public void onWriteSuccess(int i, int i2, byte[] bArr2) {
                    MainActivity9 mainActivity9 = MainActivity9.this;
                    ShowHelper.toastShort(mainActivity9, mainActivity9.getResources().getString(R.string.order_executed));
                }
            });
        }
        String str2 = this.nameStar;
        if (str2 != null) {
            if (str2.startsWith("PT2") || this.nameStar.startsWith("PT3") || this.nameStar.startsWith("PT4") || this.nameStar.startsWith("PT9")) {
                BleManager.getInstance().write(bleDevice, BLEServiceParameters.BLE_WRITE_SERVICE_UUID, BLEServiceParameters.BLE_WRITE_SERVICE_CHARACTER_UUID, bArr, new BleWriteCallback() { // from class: com.pusun.pusuntennis.MainActivity9.29
                    @Override // com.clj.fastble.callback.BleWriteCallback
                    public void onWriteFailure(BleException bleException) {
                    }
    ...
    public void startScan() {
        BleManager.getInstance().scan(new BleScanCallback() { // from class: com.pusun.pusuntennis.MainActivity9.30
            @Override // com.clj.fastble.callback.BleScanPresenterImp
            public void onScanStarted(boolean z) {
                MainActivity9 mainActivity9 = MainActivity9.this;
                ShowHelper.showProgressDialog(mainActivity9, mainActivity9.getResources().getString(R.string.scanning));
            }
            ...
            public void onScanFinished(List<BleDevice> list) {
                if (list == null || list.size() == 0) {
                    ...
                    MainActivity9 mainActivity9 = MainActivity9.this;
                    ShowHelper.toastLong(mainActivity9, mainActivity9.getResources().getString(R.string.no_device_found));
                    if (MainActivity9.this.connNum < 3) {
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.30.1
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivity9.this.startScan();
                            }
                        }, 1000L);
                        MainActivity9.access$5708(MainActivity9.this);
                        return;
                    }
                    return;
                }
                ...
                if (list.size() == 1 && list.get(0).getName() != null && list.get(0).getName().startsWith("PT")) {
                    MainActivity9.this.connect(list.get(0));
                    return;
                }
                ...
                if (arrayList.size() == 0) {
                    MainActivity9 mainActivity92 = MainActivity9.this;
                    ShowHelper.toastLong(mainActivity92, mainActivity92.getResources().getString(R.string.no_device_found));
                    if (MainActivity9.this.connNum < 3) {
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.30.2
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivity9.this.startScan();
                            }
                ...
                if (arrayList.size() == 1) {
                    MainActivity9.this.connect((BleDevice) arrayList.get(0));
                    return;
                }
                ...
                OptionPicker optionPicker = new OptionPicker(MainActivity9.this, strArr);
                optionPicker.setOffset(2);
                optionPicker.setSelectedIndex(0);
                optionPicker.setTextSize(18);
                optionPicker.setTitleText(MainActivity9.this.getResources().getString(R.string.select_device));
                optionPicker.setCancelText(MainActivity9.this.getResources().getString(R.string.cancel));
                optionPicker.setSubmitText(MainActivity9.this.getResources().getString(R.string.submit));
                optionPicker.setOnOptionPickListener(new OptionPicker.OnOptionPickListener() { // from class: com.pusun.pusuntennis.MainActivity9.30.3
                    @Override // cn.qqtheme.framework.picker.OptionPicker.OnOptionPickListener
                    public void onOptionPicked(String str) {
                        for (int i3 = 0; i3 < arrayList.size(); i3++) {
                            if (((BleDevice) arrayList.get(i3)).getName().equals(str)) {
                                MainActivity9.this.connect((BleDevice) arrayList.get(i3));
                                return;
                            }
                        }
                    }
            ...
            if (mac != null) {
                BleManager.getInstance().connect(mac, new BleGattCallback() {
                    ...
                    public void onStartConnect() {
                        MainActivity9 mainActivity = MainActivity9.this;
                    ...
                    public void onConnectFail(BleDevice bleDevice3, BleException bleException) {
                        ...
                        MainActivity9.this.blenoty.setText(MainActivity9.this.getResources().getString(R.string.disconnected));
                        MainActivity9.this.blenoty.setBackground(MainActivity9.this.getResources().getDrawable(R.drawable.button_stop_selector));
                        MainActivity9.this.signal.setBackground(MainActivity9.this.getResources().getDrawable(R.drawable.bicon_gray));
                        MainActivity9.this.signal_note.setText(MainActivity9.this.getResources().getString(R.string.device_is_disconnect));
                        MainActivity9.this.signal_note.setTextColor(MainActivity9.this.getResources().getColor(R.color.icon_gray));
                        BleManager.getInstance().disconnectAllDevice();
                    }
                    @Override
                    public void onConnectSuccess(BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ShowHelper.setProgressDialogMessage(MainActivity9.this.getResources().getString(R.string.initializing));
                        MainActivity9.this.connNum = 0;
                        ...
                        if (resolvedName == null || resolvedName.isEmpty()) resolvedName = MainActivity9.this.deviceName != null ? MainActivity9.this.deviceName : "";
                        MainActivity9.this.nameStar = resolvedName;
                        ...
                        MainActivity9.this.signal_note.setTextColor(MainActivity9.this.getResources().getColor(R.color.icon_green));
                        MainActivity9.this.signal.setBackground(MainActivity9.this.getResources().getDrawable(R.drawable.bicon_blue));
                        MainActivity9.this.isFaultOn = 0;
                        MainActivity9.this.gatt = bluetoothGatt;
                        MainActivity9.bleDevice = bleDevice3;
                        if (bleDevice3.getMac() != null) MainActivity9.this.deviceMac = bleDevice3.getMac();
                        MainActivity9.this.startNotify();
                    }
                    @Override
                    public void onDisConnected(boolean z, final BleDevice bleDevice3, android.bluetooth.BluetoothGatt bluetoothGatt, int i) {
                        ...
                        BleManager.getInstance().disconnectAllDevice();
                        MainActivity9.this.isFaultOn = 0;
                        if (z || MainActivity9.this.connNum >= 3) { return; }
                        new android.os.Handler().postDelayed(new Runnable() {
                            @Override public void run() { MainActivity9.this.connect(bleDevice3); }
                        }, 1000L);
                    }
                });
            } else {
                android.util.Log.e("MainActivity9", "connect: bleDevice and mac are both null, cannot connect");
            }
            return;
        }
        BleManager.getInstance().connect(bleDevice2, new BleGattCallback() { // from class: com.pusun.pusuntennis.MainActivity9.31
            @Override // com.clj.fastble.callback.BleGattCallback
            public void onStartConnect() {
                MainActivity9 mainActivity9 = MainActivity9.this;
                ShowHelper.showProgressDialog(mainActivity9, mainActivity9.getResources().getString(R.string.connecting_device));
            }

            @Override // com.clj.fastble.callback.BleGattCallback
            public void onConnectFail(final BleDevice bleDevice3, BleException bleException) {
                MainActivity9 mainActivity9 = MainActivity9.this;
                ShowHelper.toastLong(mainActivity9, mainActivity9.getResources().getString(R.string.connect_failure_check));
                ShowHelper.dismissProgressDialog();
                MainActivity9.this.blenoty.setText(MainActivity9.this.getResources().getString(R.string.disconnected));
                MainActivity9.this.blenoty.setBackground(MainActivity9.this.getResources().getDrawable(R.drawable.button_stop_selector));
                MainActivity9.this.signal.setBackground(MainActivity9.this.getResources().getDrawable(R.drawable.bicon_gray));
                ...
                MainActivity9.this.signal_note.setTextColor(MainActivity9.this.getResources().getColor(R.color.icon_gray));
                BleManager.getInstance().disconnectAllDevice();
                if (MainActivity9.this.connNum >= 3 || bleDevice3 == null) {
                    return;
                }
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.31.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.connect(bleDevice3);
                    }
                }, 1000L);
                MainActivity9.access$5708(MainActivity9.this);
            }
            ...
            public void onConnectSuccess(BleDevice bleDevice3, BluetoothGatt bluetoothGatt, int i) {
                ShowHelper.setProgressDialogMessage(MainActivity9.this.getResources().getString(R.string.initializing));
                MainActivity9.this.connNum = 0;
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.31.2
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        ShowHelper.dismissProgressDialog();
                        ShowHelper.toastShort(MainActivity9.this, MainActivity9.this.getResources().getString(R.string.please_use));
                ...
                if (rawNameMainAc == null || rawNameMainAc.isEmpty()) rawNameMainAc = MainActivity9.this.deviceName != null ? MainActivity9.this.deviceName : "";
                MainActivity9.this.nameStar = rawNameMainAc;
                MainActivity9.this.blenoty.setText(MainActivity9.this.getResources().getString(R.string.connected));
                MainActivity9.this.blenoty.setBackground(MainActivity9.this.getResources().getDrawable(R.drawable.button_selector));
                MainActivity9.this.signal_note.setText(MainActivity9.this.nameStar + MainActivity9.this.getResources().getString(R.string.connected));
                MainActivity9.this.signal_note.setTextColor(MainActivity9.this.getResources().getColor(R.color.icon_green));
                ...
                MainActivity9.this.gatt = bluetoothGatt;
                MainActivity9.bleDevice = bleDevice3;
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.31.3
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
            ...
            public void onDisConnected(boolean z, final BleDevice bleDevice3, BluetoothGatt bluetoothGatt, int i) {
                ...
                BleManager.getInstance().disconnectAllDevice();
                MainActivity9.this.isFaultOn = 0;
                if (z || MainActivity9.this.connNum >= 3) {
                    return;
                }
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.31.4
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.connect(bleDevice3);
                    }
    ...
    public void startNotify() {
        String str = this.nameStar;
        if (str != null && (str.startsWith("PT0") || this.nameStar.startsWith("PT1"))) {
            BleManager.getInstance().notify(bleDevice, BLEServiceParameters.BLE_NOTIFY_SERVICE_UUIDA, BLEServiceParameters.BLE_NOTIFY_SERVICE_CHARACTERISTIC_UUIDA, new BleNotifyCallback() { // from class: com.pusun.pusuntennis.MainActivity9.32
                ...
                public void onCharacteristicChanged(byte[] bArr) {
                    ...
                    if (bArr.length > 2 && (bArr[1] & 255) == 3) {
                        MainActivity9.this.batteryVolumeMsg(bArr[2] & 255);
                    }
                    if (bArr.length > 2 && (bArr[1] & 255) == 94 && MainActivity9.this.isFaultOn == 0) {
                        MainActivity9.access$6308(MainActivity9.this);
                        MainActivity9.this.faultMsg(bArr[2] & 255);
                    }
                }
            });
        }
        String str2 = this.nameStar;
        if (str2 != null && (str2.startsWith("PT2") || this.nameStar.startsWith("PT3") || this.nameStar.startsWith("PT9") || this.nameStar.startsWith("PT6"))) {
            BleManager.getInstance().notify(bleDevice, BLEServiceParameters.BLE_NOTIFY_SERVICE_UUID, BLEServiceParameters.BLE_NOTIFY_SERVICE_CHARACTERISTIC_UUID, new BleNotifyCallback() { // from class: com.pusun.pusuntennis.MainActivity9.33
                @Override // com.clj.fastble.callback.BleNotifyCallback
                public void onNotifyFailure(BleException bleException) {
                }
                ...
                public void onCharacteristicChanged(byte[] bArr) {
                    AppLog.e("notify:" + bArr.length + "指令：" + (bArr[1] & 255));
                    if (bArr.length > 2 && (bArr[1] & 255) == 3) {
                        MainActivity9.this.batteryVolumeMsg(MainActivity9.getShort(bArr[2], bArr[3]));
                    }
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.34
            @Override // java.lang.Runnable
            public synchronized void run() {
                MainActivity9.this.checkPower();
            }
        }, 3600L);
        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.35
            @Override // java.lang.Runnable
            public synchronized void run() {
                if (MainActivity9.this.forbid == 1) {
                    MainActivity9.this.writeBleData(new byte[]{-86, 99, 10, 0, 0, 0, 0, 0, 105, -91});
                }
            }
        }, 3700L);
    }
    ...
    private void onPermissionGranted(String str) {
        ...
        if (str.equals("android.permission.ACCESS_FINE_LOCATION")) {
            if (Build.VERSION.SDK_INT >= 23 && !checkGPSIsOpen()) {
                new AlertDialog.Builder(this).setTitle(getResources().getString(R.string.notice)).setMessage(getResources().getString(R.string.blue_need_setting)).setNegativeButton(getResources().getString(R.string.cancel), new DialogInterface.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.37
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                        MainActivity9.this.finish();
                    }
                }).setPositiveButton(getResources().getString(R.string.go_setting), new DialogInterface.OnClickListener() { // from class: com.pusun.pusuntennis.MainActivity9.36
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                        MainActivity9.this.startActivityForResult(new Intent("android.settings.LOCATION_SOURCE_SETTINGS"), 1);
                    }
        ...
        switch (id) {
            case R.id.btn_ball /* 2131361912 */:
                if (this.blenoty.getText().toString().equals(getResources().getString(R.string.disconnected))) {
                    ...
                    if (this.forbid == 1) {
                        ...
                        if (this.modeCate == 0) {
                            ...
                            if (this.modeNum == 2) {
                                ...
                                if (this.stopMode != 2) {
                                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.75
                                        @Override // java.lang.Runnable
                                        public synchronized void run() {
                                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                                            MainActivity9.this.velobar.setProgress(7.0f);
                                            MainActivity9.this.v_tv.setText("" + MainActivity9.this.veloTins[6]);
                                        }
                                    }, 100L);
                                }
                            }
                            if (this.modeNum == 3) {
                                ...
                                if (this.stopMode != 3) {
                                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.76
                                        @Override // java.lang.Runnable
                                        public synchronized void run() {
                                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                                            MainActivity9.this.velobar.setProgress(7.0f);
                            ...
                            if (this.modeNum == 4) {
                                ...
                                if (this.stopMode != 4) {
                                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.77
                                        @Override // java.lang.Runnable
                                        public synchronized void run() {
                                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                                            MainActivity9.this.velobar.setProgress(7.0f);
                            ...
                            if (this.modeNum == 5) {
                                AppLog.e("isN:" + this.isNumDing + "sM:" + this.stopMode);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.78
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                                    }
                                }, 200L);
                            }
                            if (this.modeNum == 6) {
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.79
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        int i2;
                                        int unused = MainActivity9.this.tagC;
                                        int i3 = 15;
                                        int i4 = 11;
                                        int i5 = MainActivity9.this.tagC == 2 ? 15 : 11;
                                        int i6 = 13;
                                        if (MainActivity9.this.tagC == 3) {
                                            i5 = 13;
                                            i2 = 1;
                                        } else {
                                            i2 = 3;
                                        }
                                        if (MainActivity9.this.tagC == 4) {
                                            i2 = 5;
                                        } else {
                                            i6 = i5;
                                        }
                                        if (MainActivity9.this.tagC == 5) {
                                            i2 = 5;
                                        } else {
                                            i4 = i6;
                                        }
                                        if (MainActivity9.this.tagC == 6) {
                                            i2 = 1;
                                        } else {
                                            i3 = i4;
                                        }
                                        MainActivity9.this.writeBleData(new byte[]{-86, 109, 1, (byte) i3, (byte) i2, 0, 0, 0, (byte) ((i3 ^ 108) ^ i2), -91});
                                    }
                                }, 5L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.80
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 109, 2, 0, 0, 0, 0, 0, 111, -91});
                                    }
                                }, 50L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.81
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 109, 3, 0, 0, 0, 0, 0, 110, -91});
                                    }
                                }, 80L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.82
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 109, 4, 0, 0, 0, 0, 0, 105, -91});
                                    }
                                }, 110L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.83
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 109, 5, 0, 0, 0, 0, 0, 104, -91});
                                    }
                                }, 140L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.84
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 109, 6, 0, 0, 0, 0, 0, 107, -91});
                                    }
                                }, 170L);
                                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.85
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 5, 0, 0, 0, 0, 0, 111, -91});
                                    }
                                }, 250L);
                                if (this.stopMode != 6) {
                                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.86
                                        @Override // java.lang.Runnable
                                        public synchronized void run() {
                                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                                            MainActivity9.this.velobar.setProgress(7.0f);
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.87
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                int progress = MainActivity9.this.velobar.getProgress() - 1;
                                MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[progress], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[progress] ^ 99), -91});
                            }
                        }, 10L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.88
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                int progress = MainActivity9.this.freq.getProgress() - 1;
                                MainActivity9.this.writeBleData(new byte[]{-86, 97, (byte) MainActivity9.this.frequentNums[progress], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.frequentNums[progress] ^ 97), -91});
                            }
                        }, 1000L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.89
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivity9.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 111, -91});
                            }
                        }, 160L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.90
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                            }
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.91
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 260L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.92
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.checkPower();
                        }
            ...
            case R.id.down_up /* 2131361990 */:
                ...
                hideUD();
                if (this.modeNum != 3) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.46
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                            MainActivity9.this.velobar.setProgress(7.0f);
                ...
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.47
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    ...
                    if (this.modeCate == 0) {
                        ...
                        if (this.modeNum == 3) {
                            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.48
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (MainActivity9.this.tagV == 1) {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 3, 0, 0, 0, 0, 0, 105, -91});
                                    }
                                    if (MainActivity9.this.tagV == 2) {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 3, 3, 8, Ascii.CR, 0, 0, 111, -91});
                                    }
                                    if (MainActivity9.this.tagV == 3) {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 3, 3, Ascii.CR, 0, 0, 0, 103, -91});
                                    }
                                }
                            }, 30L);
                        }
            ...
            case R.id.group_cross /* 2131362113 */:
                ...
                this.points.setVisibility(8);
                if (this.modeNum != 6) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.54
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                            MainActivity9.this.velobar.setProgress(7.0f);
                ...
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.55
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    }, 250L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.56
                        @Override // java.lang.Runnable
                        public void run() {
                            int i4;
                            int unused = MainActivity9.this.tagC;
                            int i5 = 15;
                            int i6 = 11;
                            int i7 = MainActivity9.this.tagC == 2 ? 15 : 11;
                            int i8 = 13;
                            if (MainActivity9.this.tagC == 3) {
                                i7 = 13;
                                i4 = 1;
                            ...
                            MainActivity9.this.writeBleData(new byte[]{-86, 109, 1, (byte) i5, (byte) i4, 0, 0, 0, (byte) ((i5 ^ 108) ^ i4), -91});
                        }
                    }, 5L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.57
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 109, 2, 0, 0, 0, 0, 0, 111, -91});
                        }
                    }, 50L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.58
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 109, 3, 0, 0, 0, 0, 0, 110, -91});
                        }
                    }, 80L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.59
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 109, 4, 0, 0, 0, 0, 0, 105, -91});
                        }
                    }, 110L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.60
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 109, 5, 0, 0, 0, 0, 0, 104, -91});
                        }
                    }, 140L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.61
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 109, 6, 0, 0, 0, 0, 0, 107, -91});
                        }
                    }, 170L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.62
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 106, 5, 0, 0, 0, 0, 0, 111, -91});
                        }
            ...
            case R.id.high_point /* 2131362124 */:
                ...
                if (i4 != 5) {
                    ...
                    if (i4 == 1) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.49
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                ShowHelper.dismissProgressDialog();
                            }
                        }, 1300L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.50
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                ShowHelper.dismissProgressDialog();
                            }
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.51
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivity9.this.velobar.getProgress();
                        MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[3], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[3] ^ 99), -91});
                        MainActivity9.this.velobar.setProgress(4.0f);
                        MainActivity9.this.v_tv.setText("" + MainActivity9.this.veloTins[3]);
                    }
                }, 50L);
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.52
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    ...
                    if (this.modeCate == 0 && this.modeNum == 5) {
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.53
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivity9.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                            }
            ...
            case R.id.hit /* 2131362126 */:
                ...
                this.modeCate = 0;
                changeOperate();
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.63
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[5], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[5] ^ 99), -91});
                        MainActivity9.this.velobar.setProgress(6);
                        MainActivity9.this.v_tv.setText("" + MainActivity9.this.veloTins[5]);
                    }
                }, 50L);
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.64
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 102, -91});
                        }
                    }, 100L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.65
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                        }
            ...
            case R.id.left_right /* 2131362169 */:
                ...
                showUD();
                if (this.modeNum != 2) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.43
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                            MainActivity9.this.velobar.setProgress(7.0f);
                ...
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.44
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    ...
                    if (this.modeCate == 0) {
                        ...
                        if (this.modeNum == 2 && this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                            new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.45
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (MainActivity9.this.tagH == 1) {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 2, 0, 0, 0, 0, 0, 104, -91});
                                    }
                                    if (MainActivity9.this.tagH == 2) {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 2, Ascii.SI, Ascii.NAK, 0, 0, 0, 114, -91});
                                    }
                                    if (MainActivity9.this.tagH == 3) {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 2, Ascii.DLE, Ascii.DC4, 0, 0, 0, 110, -91});
                                    }
                                    if (MainActivity9.this.tagH == 4) {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 2, 17, 19, 0, 0, 0, 106, -91});
                                    }
                                    if (MainActivity9.this.tagH == 5) {
                                        MainActivity9.this.writeBleData(new byte[]{-86, 106, 2, Ascii.SI, Ascii.DC2, Ascii.NAK, 0, 0, 96, -91});
                                    }
                                }
                            }, 30L);
                        }
            ...
            case R.id.place /* 2131362332 */:
                ...
                if (i6 != 8) {
                    ...
                    if (i6 == 1) {
                        ShowHelper.showProgressDialog(this, getResources().getString(R.string.change_point));
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.67
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                ShowHelper.dismissProgressDialog();
                            }
                        }, 1300L);
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.68
                            @Override // java.lang.Runnable
                            public synchronized void run() {
                                ShowHelper.dismissProgressDialog();
                            }
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.69
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        if (MainActivity9.this.velobar.getProgress() > 2) {
                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[0], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[0] ^ 99), -91});
                            MainActivity9.this.velobar.setProgress(1.0f);
                            MainActivity9.this.v_tv.setText("" + MainActivity9.this.veloTins[0]);
                        }
                    }
                }, 50L);
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.70
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivity9.this.rotatebar.setProgress(0.0f);
                        MainActivity9.this.r_tv.setText("0");
                        MainActivity9.this.writeBleData(new byte[]{-86, 98, 0, 0, 0, 0, 0, 0, 99, -91});
                    }
                }, 150L);
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.71
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
                    ...
                    if (this.modeCate == 0 && this.modeNum == 8) {
                        new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.72
                            @Override // java.lang.Runnable
                            public void run() {
                                MainActivity9.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                            }
            ...
            case R.id.selection /* 2131362414 */:
                ...
                this.modeCate = 1;
                changeOperate();
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.66
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                        MainActivity9.this.velobar.setProgress(7.0f);
            ...
            case R.id.self_point /* 2131362423 */:
                ...
                if (this.modeNum != 1) {
                    this.isNumDing = 0;
                    ShowHelper.showProgressDialog(this, getResources().getString(R.string.change_point));
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.38
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            ShowHelper.dismissProgressDialog();
                        }
                    }, 1300L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.39
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            ShowHelper.dismissProgressDialog();
                        }
                ...
                this.modeCate = 0;
                changeOperate();
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.40
                    @Override // java.lang.Runnable
                    public synchronized void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                        MainActivity9.this.velobar.setProgress(7.0f);
                ...
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.41
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 102, -91});
                        }
                    }, 100L);
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.42
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 106, 1, 0, 0, 0, 0, 0, 107, -91});
                        }
            ...
            case R.id.whole /* 2131362658 */:
                ...
                if (this.modeNum != 4) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.73
                        @Override // java.lang.Runnable
                        public synchronized void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 99, (byte) MainActivity9.this.veloNums[6], 0, 0, 0, 0, 0, (byte) (MainActivity9.this.veloNums[6] ^ 99), -91});
                            MainActivity9.this.velobar.setProgress(7.0f);
                ...
                this.start_layout.setGravity(1);
                if (this.btn_ball.getText().toString().equals(getResources().getString(R.string.stop))) {
                    new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.74
                        @Override // java.lang.Runnable
                        public void run() {
                            MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                        }
    ...
    class TimeCount1 extends CountDownTimer {
        ...
        public void onTick(long j) {
            if (20000 - j > 700) {
                MainActivity9.access$1612(MainActivity9.this, 50);
                if (MainActivity9.this.ud < 50) {
                    MainActivity9.this.ud = 50;
                }
                if (MainActivity9.this.ud > 4250) {
                    MainActivity9.this.ud = 4250;
                }
                short s = (short) MainActivity9.this.lr;
                if (MainActivity9.this.modeNum == 2) {
                    s = 0;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.TimeCount1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
    ...
    class TimeCount2 extends CountDownTimer {
        ...
        public void onTick(long j) {
            if (20000 - j > 700) {
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.TimeCount2.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
    ...
    class TimeCount3 extends CountDownTimer {
        ...
        public void onTick(long j) {
            if (20000 - j > 700) {
                MainActivity9.access$1712(MainActivity9.this, 50);
                if (MainActivity9.this.lr < 50) {
                    MainActivity9.this.lr = 50;
                }
                if (MainActivity9.this.lr > 4250) {
                    MainActivity9.this.lr = 4250;
                }
                short s = (short) MainActivity9.this.lr;
                if (MainActivity9.this.modeNum == 2) {
                    s = 0;
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.TimeCount3.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
    ...
    class TimeCount4 extends CountDownTimer {
        ...
        public void onTick(long j) {
            if (20000 - j > 700) {
                MainActivity9.access$1720(MainActivity9.this, 50);
                if (MainActivity9.this.lr < 50) {
                    MainActivity9.this.lr = 50;
                }
                if (MainActivity9.this.lr > 4250) {
                ...
                new Handler().postDelayed(new Runnable() { // from class: com.pusun.pusuntennis.MainActivity9.TimeCount4.1
                    @Override // java.lang.Runnable
                    public void run() {
                        MainActivity9.this.writeBleData(new byte[]{-86, 102, 0, 0, 0, 0, 0, 0, 103, -91});
                    }
