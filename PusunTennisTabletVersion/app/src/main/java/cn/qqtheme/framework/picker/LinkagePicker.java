...
public class LinkagePicker extends WheelPicker {
    ...
    protected View makeCenterView() {
        ...
        wheelView.setOnWheelViewListener(new WheelView.OnWheelViewListener() { // from class: cn.qqtheme.framework.picker.LinkagePicker.1
            ...
            public void onSelected(boolean z, int i2, String str) {
                ...
                LinkagePicker.this.selectedFirstIndex = i2;
                LinkagePicker.this.selectedThirdIndex = 0;
                wheelView2.setItems(LinkagePicker.this.secondList.get(LinkagePicker.this.selectedFirstIndex), z ? 0 : LinkagePicker.this.selectedSecondIndex);
                if (LinkagePicker.this.thirdList.size() == 0) {
                    return;
                }
                wheelView3.setItems(LinkagePicker.this.thirdList.get(LinkagePicker.this.selectedFirstIndex).get(0), z ? 0 : LinkagePicker.this.selectedThirdIndex);
            }
        });
        ...
        wheelView2.setOnWheelViewListener(new WheelView.OnWheelViewListener() { // from class: cn.qqtheme.framework.picker.LinkagePicker.2
            ...
            public void onSelected(boolean z, int i2, String str) {
                ...
                LinkagePicker.this.selectedSecondIndex = i2;
                if (LinkagePicker.this.thirdList.size() == 0) {
                    return;
                }
                wheelView3.setItems(LinkagePicker.this.thirdList.get(LinkagePicker.this.selectedFirstIndex).get(LinkagePicker.this.selectedSecondIndex), z ? 0 : LinkagePicker.this.selectedThirdIndex);
            }
        });
        ...
        wheelView3.setOnWheelViewListener(new WheelView.OnWheelViewListener() { // from class: cn.qqtheme.framework.picker.LinkagePicker.3
            ...
            public void onSelected(boolean z, int i2, String str) {
                ...
                LinkagePicker.this.selectedThirdIndex = i2;
            }
        });
        return linearLayout;
    }
    ...
    public void onSubmit() {
        ...
        if (onLinkageListener != null) {
            if (this.onlyTwo) {
                onLinkageListener.onPicked(this.selectedFirstText, this.selectedSecondText, null);
            } else {
                onLinkageListener.onPicked(this.selectedFirstText, this.selectedSecondText, this.selectedThirdText);
            }
        }
    }
}
